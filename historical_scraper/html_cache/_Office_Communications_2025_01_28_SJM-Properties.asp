...
<meta name="description" content="Attorney General Ellison reaches settlement with sham nonprofit and its founder over violations of the Minnesota Nonprofit Corporation Act">
...
<meta name="twitter:title" content="Attorney General Ellison reaches settlement with sham nonprofit and its founder over violations of the Minnesota Nonprofit Corporation Act" />
<meta name="twitter:description" content="Previously, Attorney General Ellison sued nonprofit founder and landlord Steven Meldahl for living conditions at his properties that a judge compared to a âbiblical plagueâ" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2025/01/28_SJM-Properties.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison reaches settlement with sham nonprofit and its founder over violations of the Minnesota Nonprofit Corporation Act" />
<meta property="og:description" content="Previously, Attorney General Ellison sued nonprofit founder and landlord Steven Meldahl for living conditions at his properties that a judge compared to a âbiblical plagueâ" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>January 28, 2025 Press Release</title>
...
<h1>Attorney General Ellison reaches settlement with sham nonprofit and its founder over violations of the Minnesota Nonprofit Corporation Act</h1>
<p class="lede">Previously, Attorney General Ellison sued nonprofit founder and landlord Steven Meldahl for living conditions at his properties that a judge compared to a âbiblical plagueâ</p>
	




 <p style="padding-top:2em;"><strong>January 28, 2025Â  (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison announced today that he has reached aÂ <a href="https://www.ag.state.mn.us/Office/Communications/2025/docs/SJM-Properties_AoD.pdf">settlement</a>Â with Minnesota nonprofit SJM Properties (&ldquo;SJM&rdquo;) and its founder and President, Steven Meldahl, alleging Meldahl ran a sham nonprofit and violated numerous other governance requirements under Minnesota charities laws. TheÂ <a href="https://www.ag.state.mn.us/Office/Communications/2025/docs/SJM-Properties_AoD.pdf">settlement</a>, also known as an Assurance of Discontinuance, requires that SJM be formally dissolved and prohibits Meldahl from serving as a director, officer or employee of a nonprofit and engaging in any activity that results in Meldahl having control or responsibility over any property held for a charitable purpose.</p>
 
 <p>&ldquo;The evidence surrounding this investigationâincluding my prior action against Meldahl as a landlord, his criminal prosecution, and my independent investigationâall prove that SJM is a complete sham created to further Meldahl&rsquo;s private gain,&rdquo;Â <strong>Attorney General Ellison said.</strong>Â  &ldquo;Shutting it down is the right thing to do. My Office will continue working to hold people accountable when they break the law and use charities or charitable assets to enrich themselves.&rdquo;</p>
 
 <p>SJM was founded in in 2008 by Meldahl with the charitable mission to &ldquo;provide clean, safe, remodeled and affordable housing for low to moderate income families&rdquo; and &ldquo;prevent community deterioration by purchasing and remodeling substandard housing in inner city areas of Minnesota.&rdquo;</p>
 
 <p>On August 20, 2023, Meldahl was charged with several counts of tax evasion and fraud in Hennepin County, which alleged that Meldahl used SJM&rsquo;s sales tax exemption certificates to avoid paying sales tax at several retail stores. The Charities Division launched an independent investigation under Minnesota&rsquo;s civil nonprofit corporation laws.Â  The investigation revealed grounds to dissolve the organization as a sham. Further, in his May 2024 plea agreement, Meldahl admitted to using SJM as a ruse to avoid paying state sales tax for his rental property business.Â  As part of his plea agreement, Meldahl agreed to cooperate with the AGO in the formal dissolution of SJM.</p>
 
 <p>Attorney General Ellison hadÂ <a href="https://www.ag.state.mn.us/Office/Communications/2019/10/08_MinneapolisLandlord.asp">previously sued Meldahl</a>Â in October 2019 for violating tenants&rsquo; rights.Â  In that lawsuit, the court ruled that Meldahl knowingly and in bad faith violated the rights of 267 low-income families who rented from him.Â  Specifically, Meldahl charged tenants more than 8% in late fees and prevented them from having their homes inspected by the City of Minneapolis.Â  The court found that Meldahl engaged in &ldquo;brazen and deplorable illegal business conduct harming a vulnerable part of Minnesota&rsquo;s population&rdquo; and that issues with the living conditions in some of his properties were of &ldquo;<a href="https://www.ag.state.mn.us/Office/Communications/2022/03/23_Meldhal.asp">biblical plague proportions</a>.&rdquo; Meldahl was also ordered to reimburse the AGO $1 million in legal fees.</p>
 
 <p>In Minnesota, the Attorney General through the Charities Division has civil enforcement authority over the state&rsquo;s nonprofit corporation and charitable-solicitation, and charitable-trust laws. The Charities Division does not enforce criminal laws.Â  Under state law, nonprofit executives owe fiduciary duties to act in the best interests of the charities that they serve, including putting the interests of the nonprofit above any personal financial interests.</p>
 
 <p>Minnesotans with concerns about governance or other issues of a nonprofitÂ <a href="https://www.ag.state.mn.us/Charity/Forms/CharitiesComplaintForm.pdf">may submit a complaint on the Attorney General&rsquo;s website</a>.Â  Minnesota consumers may also contact the Attorney General&rsquo;s Office by calling (651) 296-3353 (Metro area), (800) 657-3787 (Greater Minnesota), or (800) 627-3529 (Minnesota Relay).</p>
