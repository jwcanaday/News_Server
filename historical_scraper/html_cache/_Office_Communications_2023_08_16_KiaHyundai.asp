...
<meta name="description" content="Federal court tentatively declines to approve agreement in Hyundai/Kia private consumer class-action settlement">
...
<meta name="twitter:title" content="Federal court tentatively declines to approve agreement in Hyundai/Kia private consumer class-action settlement" />
<meta name="twitter:description" content="Courtâs refusal to approve agreement comes shortly after AG Ellison led letter to court recommending it strengthen settlement to require Hyundai/Kia recall or buy back theft-prone vehicles" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2023/08/16_KiaHyundai.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Federal court tentatively declines to approve agreement in Hyundai/Kia private consumer class-action settlement"/>
<meta property="og:description" content="Courtâs refusal to approve agreement comes shortly after AG Ellison led letter to court recommending it strengthen settlement to require Hyundai/Kia recall or buy back theft-prone vehicles" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>August 16, 2023 Press Release</title>
...
<div id="browseMobile" class="hide-on-desktop">
 ...
 <div id="content">
   ...
   <h1 align="center">Federal court tentatively declines to approve agreement in Hyundai/Kia private consumer class-action settlement </h1>
   
<p class="lede">Courtâs refusal to approve agreement comes shortly after AG Ellison led letter to court recommending it strengthen settlement to require Hyundai/Kia recall or buy back theft-prone vehicles </p>
<p class="lede">Court finds several factors weigh against finding class-action agreement is fair and adequate</p>

  
 
     <p align="left"><strong>August 16, 2023 (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison<strong>Â </strong>announced today that the federal court overseeing a private consumer class-action settlement involving Hyundai and Kia&rsquo;s theft-prone vehicles hasÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/docs/KiaHyundai_ClassAction_CourtOrder.pdf" target="_blank">declined to preliminarily approve the settlement agreement</a>. In its order, the federal court found that several factors weigh against a finding that the settlement agreement is fair and adequate. The ruling comes afterÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/08/14_KiaHyundai.asp" target="_blank">Attorney General Ellison led a coalition of<strong>Â </strong>seven attorneys general earlier this week in urging the federal court to strengthen the settlement</a>Â by requiring Hyundai and Kia to recall or buy back their theft-prone vehicles and equip them with engine-immobilizer technology that the vehicles currently lack.Â Â Â </p>
     
     <p align="left">Among the terms of the private consumer settlement as proposed were a requirement that Hyundai and Kia provide a &ldquo;software upgrade&rdquo; for only a certain subset of their vehicles that will extend the length of the vehicles&rsquo; alarm from 30 seconds to 1 minute and requires the key to be in the ignition to start the vehicle. For vehicles for which the software upgrade is incompatible, the proposed settlement required Hyundai and Kia to reimburse consumers up to $300 for their purchase of a wheel lock or anti-theft system.Â Â Â </p>
     
     <p align="left">In theÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/docs/KiaHyundai_Ltr_ProposedSettlement.pdf" target="_blank">letter</a>Â that Attorney General Ellison led, he and the coalition expressed grave concerns that settlement agreement&rsquo;s proposed remedies are insufficient to resolve the ongoing rash of Hyundai and Kia thefts that continue to harm public safety. For example, the supposed &ldquo;software upgrade&rdquo; is not feasible for approximately 2.3 million theft-prone vehicles, is being slowly rolled out in phases that will take months (or years) to complete, and requires consumers to proactively seek it out. The attorneys general also explained their serious concerns with the effectiveness of the &ldquo;software upgrade,&rdquo; as it has already been available for six months or more in the real world and during that time the high rate of Hyundai and Kia thefts has not abated, with ensuing harms to public safety. For example, in July 2023, the number of Hyundai and Kia vehicles stolen in Minneapolis alone (313 vehicles) was still more than 15 times higher than it was in July 2021 (20 vehicles).Â Â </p>
     
     <p align="left">In itsÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/docs/KiaHyundai_ClassAction_CourtOrder.pdf" target="_blank">ruling</a>, the federal court highlighted concerns that the Attorney General Ellison<strong>Â </strong>and the coalition had raised in their letter regarding the effectiveness of the software upgrade, including that: (1) even vehicles that have the update are still susceptible to theft; (2) there are vehicles for which the software upgrade is incompatible; and (3)Â the insufficient number of vehicles that have received the software upgrade to date. The Court also held that a hearing may be needed for the parties to demonstrate the software upgrade&rsquo;s technology and explain how it works, its deficiencies, and potential solutions.Â </p>
     
    <p align="left">&ldquo;I&rsquo;m pleased the court has heard our concerns.Â The simple fact remains that too many Kia and Hyundai vehicles lack industry-standard anti-theft technology that nearly every other vehicle in America has. As a result, thefts of their vehicles have increased astronomically around the country and Americans are less safe. The companies know this and could choose to truly fix the problem today. Instead, they continue to offer half-measures that won't fix the problem and put the burden and the cost on consumers, not on themselves where it belongs,&rdquo; Attorney General Ellison said.Â </p>
     
     <h2 align="left">Minnesota has experienced a drastic increase in Kia and Hyundai theftsÂ </h2>
     
     <p align="left">People who want to steal cars are well aware of the lack of anti-theft technology in many of Kia and Hyundai&rsquo;s vehicles, which has led to a drastic increase of Kia and Hyundai vehicle thefts throughout the nation, including in Minnesota. For example, reported thefts of Kia and Hyundai vehicles increased by 836% in Minneapolis and 611% in Saint Paul from 2021 to 2022. Some vehicles have even been stolen multiple times in the same year.Â </p>
     
     <p align="left">These stolen vehicles have been used in violent crimes in Minnesota and have been involved in numerous traffic collisions, some of which have been fatal. For example, in Minneapolis alone, in 2022 Kia and Hyundai vehicle thefts were tied to at least:Â Â </p>
    <ul class="noSpace">
       <li>Five homicides;Â </li>
       <li>13 shootings;Â </li>
       <li>36 robberies; andÂ </li>
       <li>265 motor vehicle accidents.Â </li>
     </ul>
    <p align="left">Â These are not just numbers; they are public-safety incidents that have caused substantial and serious harm to our neighbors and communities. As just one example, in December 2022, a 14-year-old boy lost his life in Minneapolis after getting into a single-vehicle crash that involved a stolen Kia.Â </p>
     
     <h2 align="left">AG Ellison leading fight to make Kia, Hyundai vehicles saferÂ </h2>
     
     <p align="left">Attorney General Ellison has been leading the fight to make Kia and Hyundai vehicles safer since early 2023. Yesterday&rsquo;s court order follows the letter AG Ellison led to the federal court urging it to strengthen the Hyundai/Kia private consumer class-action settlement.Â Â It also follows Attorney General Ellison&rsquo;sÂ announcement in March 2023Â that he was launching a civil investigation into Hyundai and Kia&rsquo;s sale of these theft-prone vehicles. The order also follows an April 2023 letter Attorney General Ellison sent as part of a coalition of 18 attorneys general that called on the National Highway Traffic Safety Administration to recall Hyundai&rsquo;s and Kia&rsquo;s theft-prone vehicles, as well as a March 2023Â letterÂ he sent with Minneapolis Mayor Jacob Frey, and Saint Paul Mayor Melvin Carter III to Kia and Hyundai that pressed the companies for an immediate safety recall to stem the rise of thefts of their vehicles.Â </p>
     
     <p align="left">Attorney General Ellison&rsquo;s civil investigation is active and ongoing.Â Â </p>
     
     <p align="left">Attorney General Ellison urges Minnesota consumers who wish to report concerns about the theft or risk of theft of their Kia or Hyundai vehicles toÂ submit a complaint onlineÂ or call the Attorney General&rsquo;s Office at (651) 296-3353 (Metro area), (800) 657-3787 (Greater Minnesota), or (800) 627-3529 (Minnesota Relay).Â Â </p>
