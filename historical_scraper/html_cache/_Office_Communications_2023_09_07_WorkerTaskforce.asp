...
<meta name="description" content="Attorney General Ellison announces members of Worker Misclassification Task Force">
...
<meta name="twitter:title" content="Attorney General Ellison announces members of Worker Misclassification Task Force " />
<meta name="twitter:description" content="Selects advocates, researchers, policymakers to serve along with legislators and representatives of state agencies; first meeting of Task Force on September 13, Rep. Greenman to co-chair" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2023/09/07_WorkerTaskforce.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison announces members of Worker Misclassification Task Force "/>
<meta property="og:description" content="Selects advocates, researchers, policymakers to serve along with legislators and representatives of state agencies; first meeting of Task Force on September 13, Rep. Greenman to co-chair" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>September 7, 2023 Press Release</title>
...
<div id="browseMobile" class="hide-on-desktop">
 ...
 <div id="content">
   ...
   <h1 align="center">Attorney General Ellison announces members of Worker Misclassification Task Force  </h1>
   
<p class="lede">Selects advocates, researchers, policymakers to serve along with legislators and representatives of state agencies; first meeting of Task Force on September 13, Rep. Greenman to co-chair </p>
<p class="lede">Task Force to explore impacts on workers, business, and public; plans to propose recommendations in time for 2024 legislative session  </p>
       ...
       <p><strong>September 7, 2023 (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison today announced that he has selected the 15 voting members of hisÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/07/06_Taskforce.asp" target="_blank">new Advisory Task Force onÂ WorkerÂ Misclassification</a>, which he announced on July 6. They include advocates, researchers, Minnesotans with an interest in the topic, a member of each body of the Minnesota Legislature, and representatives from the Minnesota Department of Labor and Industry, Department of Revenue, and Department of Employment and Economic Development.Â  Â </p>
       
       <p>The first meeting of the Task Force will take place on Wednesday, SeptemberÂ 13 from 1:00â3:00Â p.m. All meetings of the Task Force are open to the media and the public. There will also be an option to attend virtually: those details will be released early next week.Â </p>
       
       <p>Attorney General Ellison also announced that Representative Emma Greenman will serve as a co-chair of the Task Force. Task Force members will choose the other co-chair at their first meeting next week.Â </p>
       
       <p>Worker misclassification is when an employer improperly classifies an employee as an independent contractor. While some workplace roles may be appropriately assigned to independent contractors, misclassifying workers who should be considered employees can expose them to exploitation and discrimination without the basic federal and state labor-law protections to employees, such as minimum wage, overtime pay, and disability accommodations, among others. Businesses that actively practice misclassification in order to save on wages may create a competitive disadvantage in the marketplace and an uneven playing field for employers who are in compliance with the law.Â Â </p>
       
       <p>Members of the Attorney General&rsquo;s Advisory Task Force on Working Misclassification will study the issue and its impacts on workers, the business community, and the public at large; explore best practices in policy and enforcement from examples based in Minnesota and in other states and jurisdictions; and propose a set of recommendations for both enforcement and regulatory reform. The task force will publish a final report on their findings and recommendations in the spring of 2024 but plans to make initial policy recommendations in December 2023 in time for the 2024 legislative session. Â Â </p>
       
       <p>&ldquo;Misclassifying workers hurts not only those who are misclassified and their families, it hurts all Minnesotans, including businesses who do the right thing by their employees by playing by the rules, and every Minnesota taxpayer who has to make up the slack for law breaking employers,&rdquo; Attorney General Ellison said. &ldquo;I&rsquo;ve created this task force to gather the best thinking about the problem and make practical, workable recommendations to the Legislature, State agencies, other levels of government, industry, nonprofits, and advocates about how we can put an end to the problem. I&rsquo;m looking forward to the good work I know the Task Force members will do. I am grateful to them for accepting my offer to serve on the Task Force and thank everyone who applied.&rdquo;Â </p>
       
    <p>According to theÂ <a href="https://blog.dol.gov/2021/05/06/the-true-cost-of-misclassification" target="_blank">U.S. Department of Labor</a>, &ldquo;Misclassification denies employees access to critical benefits and protections they are entitled to â overtime, the minimum wage, family and medical leave and, in some cases, safe workplaces. It generates substantial losses to the U.S. Treasury and the Social Security and Medicare funds, as well as to state unemployment insurance and workers&rsquo; compensation funds. It cheats every taxpayer. It undermines the entire economy.&rdquo;Â Â </p>
       
       <h2>Members of the Task Force Â Â </h2>
       
       <p>Attorney General Ellison has selected the following people to serve as Task Force members:Â Â </p>
       <ul>
         <li>Rod Adams, Executive Director, The New Justice ProjectÂ </li>
         <li>Commissioner Nicole Blissenbach, Minnesota Department of Labor and IndustryÂ </li>
         <li>Octavio Chung Bustamante, Marketing Representative, LIUNA Minnesota and North DakotaÂ </li>
         <li>Daniel Getschel, Director, Individual Income Taxes &amp; Withholding, Minnesota Department of RevenueÂ </li>
         <li>Representative Emma Greenman, Member of the Minnesota House of RepresentativesÂ </li>
         <li>Melissa Hysing, Legislative Director, MN AFL-CIOÂ </li>
         <li>Burt Johnson, General Counsel, North Central States Regional Council of CarpentersÂ </li>
         <li>Briana Kemp, Policy Lead, Centro de Trabajadores Unidos en la Lucha (CTUL)Â </li>
         <li>Amir Malik, Compliance Manager, City of Bloomington City Attorney&rsquo;s OfficeÂ </li>
         <li>Senator Clare Oumou Verbeten, Member of the Minnesota SenateÂ </li>
         <li>Evan Rowe, Deputy Commissioner of Workforce Services and Operations, Minnesota Department of Employment and Economic Development (DEED)Â </li>
         <li>Aaron Sojourner, Senior Researcher, W. E. Upjohn Institute for Employment ResearchÂ </li>
         <li>Brittany VanDerBill, Owner, B. VanDerBill Consulting LLCÂ </li>
         <li>Kim Vu-Dinh, Associate Professor, Mitchell Hamline School of LawÂ </li>
         <li>Jonathan Weinhagen, President &amp; CEO, MinneapolisÂ RegionalÂ ChamberÂ of CommerceÂ Â </li>
       </ul>
