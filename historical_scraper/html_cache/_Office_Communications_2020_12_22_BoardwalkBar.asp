...
<meta name="description" content="Court orders E. Grand Forks establishment to comply with executive order requiring temporary closure for indoor on-premises dining ">
...
<meta name="twitter:title" content="Court orders E. Grand Forks establishment to comply with executive order requiring temporary closure for indoor on-premises dining" />
<meta name="twitter:description" content="Court also orders Boardwalk Bar and Grill to fully comply with all subsequent applicable executive orders for the duration of Stateâs lawsuit; rules Governor Walz acted within his authority  " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2020/12/22_BoardwalkBar.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Court orders E. Grand Forks establishment to comply with executive order requiring temporary closure for indoor on-premises dining " />
<meta property="og:description" content="Court also orders Boardwalk Bar and Grill to fully comply with all subsequent applicable executive orders for the duration of Stateâs lawsuit; rules Governor Walz acted within his authority  " />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>December 22, 2020 Press Release</title>
...
<h1>Court orders E. Grand Forks establishment to comply with executive order requiring temporary closure for indoor on-premises dining </h1>
<p class="lede">Court also orders Boardwalk Bar and Grill to fully comply with all subsequent applicable executive orders for the duration of Stateâs lawsuit; rules Governor Walz acted within his authority </p>



	<p><strong>December 22, 2020 (SAINT PAUL)</strong> â Minnesota Attorney General Keith Ellison announced today that Polk County District Court has granted his office&rsquo;s motion for a <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/Boardwalk_TIO.pdf" target="_blank">temporary injunction against Boardwalk Bar and Grill</a> in East Grand Forks, which the State has <a href="https://www.ag.state.mn.us/Office/Communications/2020/12/11_BoardwalkBar.asp" target="_blank">sued</a> for violating the ban on indoor, on-premises dining in <a href="https://mn.gov/governor/assets/EO%2020-99%20Final%20%28003%29_tcm1055-454294.pdf" target="_blank">Governor Tim Walz&rsquo;s Executive Order 20-99</a>. The court ordered that &ldquo;Defendant is prohibited from taking any action in violation of Governor Tim Walz&rsquo;s Executive Order 20-99 or any subsequent Executive Order&rdquo; and that &ldquo;Defendant shall fully comply with Executive Order 20-99 or any subsequent and applicable Executive Orderâ¦&rdquo; The order converts the <a href="https://www.ag.state.mn.us/Office/Communications/2020/12/11_BoardwalkBar_Update.asp" target="_blank">temporary restraining order</a> that the court previously granted into a temporary injunction that will remain in effect for the duration of the State&rsquo;s lawsuit. </p>
	
	<p>In its order, the court found &ldquo;a clear rational relationship between Executive Order 20-99    and the legitimate government interest of protecting public health&rdquo; (p. 14). It also <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/Boardwalk_TIO.pdf" target="_blank">wrote</a>:  </p>
	
	<p style="padding-left:60px;">While the Court has determined that a Temporary Injunction is appropriate to impose the restrictions detailed in Executive Order 20-99, the State acknowledges that it takes no joy in this enforcement action. The parties in this case understand the impossible choices that must be made and the emotional and financial toll imposed by these choices. </p>
	
	<p style="padding-left:60px;">â¦ However, Minnesota law provides the Governor with broad authority during peacetime emergencies. Governor Walz acted within his authority when he issued Executive Order  20-99. The Minnesota Legislature has the authority to terminate the peacetime emergency and has not done so. The temporary restrictions imposed by Executive Order 20-99 protect the legitimate state interest of protecting public health by limiting the spread of COVID-19. (p. 20) </p>
	
	<p>On December 11, 2020, Attorney General Ellison&rsquo;s office filed a <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/BoardwalkBar_Complaint.pdf" target="_blank">lawsuit</a> against Boardwalk Bar and Grill for multiple alleged violations of the temporary ban on on-premises dining in <a href="https://mn.gov/governor/assets/EO%2020-99%20Final%20%28003%29_tcm1055-454294.pdf" target="_blank">Executive Order 20-99</a>, a targeted, four-week dial-back of certain activities to halt the spread of COVID-19. <a href="https://mn.gov/governor/assets/EO%2020-103%20Final%20Signed%20and%20Filed_tcm1055-458627.pdf" target="_blank">Executive Order 20-103</a> amended and extended the provisions of Executive Order 20-99 until January 10, 2021 at 11:59 p.m. </p>
	
	<p>&ldquo;Yet another court has recognized the severity of the COVID-19 pandemic and the firm legal foundation of the State&rsquo;s legitimate interest in putting a stop to it,&rdquo; Attorney General Ellison said. &ldquo;I thank the thousands of Minnesota bars and restaurants that have done the right thing and met their responsibility to their communities by continuing to follow the law. A handful are choosing to ignore their responsibility: by so doing, they&rsquo;re simply extending the pain the pandemic has already wrought upon all of us. </p>
	
	<p>&ldquo;We&rsquo;re continuing to seek voluntarily compliance from all establishments affected by the executive orders. Enforcement action is a last resort, but I will not hesitate to use it when I have no other choice to protect Minnesotans from this deadly virus,&rdquo; Attorney General Ellison concluded. </p>
	<p>&nbsp;</p>
