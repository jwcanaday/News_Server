...
<meta name="description" content="Attorney General Ellison secures relief from unfair bill collection for Hutchinson Hospital patients">
...
<meta name="twitter:title" content="Attorney General Ellison secures relief from unfair bill collection for Hutchinson Hospital patients" />
<meta name="twitter:description" content="After unilaterally increasing patientsâ monthly medical bills, Hutchinson Hospital will restore lowest available monthly payments and refrain from future misconduct, in accordance with law and Hospital Agreement " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2020/10/29_HutchinsonHealth.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison secures relief from unfair bill collection for Hutchinson Hospital patients" />
<meta property="og:description" content="After unilaterally increasing patientsâ monthly medical bills, Hutchinson Hospital will restore lowest available monthly payments and refrain from future misconduct, in accordance with law and Hospital Agreement" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>October 29, 2020 Press Release</title>
...
<h1>Attorney General Ellison secures relief from unfair bill collection for Hutchinson Hospital patients </h1>
	<p class="lede">After unilaterally increasing patientsâ monthly medical bills, Hutchinson Hospital will restore lowest available monthly payments and refrain from future misconduct, in accordance with law and Hospital Agreement </p>

	<p><strong>October 29, 2020 (SAINT PAUL) â</strong>Â Minnesota Attorney General Keith Ellison announced today that his office has reached aÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/HutchinsonHealth_AOD.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">settlement agreement</a>Â with Hutchinson Hospital that requires it to restore more favorable hospital billing terms that it had unilaterally terminated for many of its patients, which had the effect of increasing their monthly medical bills beyond what patients agreed to pay. TheÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/HutchinsonHealth_AOD.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">Assurance of Discontinuance</a>, filed in Ramsey County District Court, alleges that Hutchinson â violating a regulatory agreement between the Attorney General&rsquo;s office and Minnesota&rsquo;s nonprofit hospitals â improperly increased patients&rsquo; payment plans, deactivated the payment plans of patients who did not agree to the new terms, and pressured patients to secure loans or use their retirement savings to satisfy their medical debts. These actions led to ballooning payments and defaults, the settlement alleges.Â </p>
	
	<p>&ldquo;High-quality, affordable healthcare is essential for people to be able to afford their lives and live with dignity and respect,&rdquo; Attorney General Ellison said.Â Â &ldquo;I expect that Minnesota&rsquo;s nonprofit hospitals will conduct their billing practices in accordance with the law, their charitable mission, and their agreement with this office. I appreciate that Hutchinson remedied its actions through this settlement. It reflects my expectation that Minnesota hospitals honor their end of the bargain when collecting medical debt from Minnesotans.&rdquo;Â </p>
	
	<p>The Attorney General&rsquo;s office launched this investigation under Minnesota law and a regulatory agreement that the Office holds with all nonprofit hospitals in Minnesota, collectively referred to as the &ldquo;Hospital Agreement.&rdquo; The Hospital Agreement protects patients against aggressive billing and debt collection practices by Minnesota nonprofit hospitals and requires that they meet certain standards of conduct imposed by their charitable missions.Â Â Among many others, the Hospital Agreement&rsquo;s provisions include:Â </p>
	
	<ul>
	  <li>Hospitals must offer a reasonable payment plan to patients who are unable to pay the full amount of their bill before sending them to collections.Â </li>
	  <li>Hospitals, after entering into a reasonable payment plan with a patient, may not refer debt to a collection agency if the patient makes payments in accordance with the terms of that payment plan agreed to by the hospital.</li>
	  <li>Hospitals must not charge uninsured patients more than they charged their &ldquo;most favored insurer&rdquo; for treatment and &ldquo;shall apply the same percentage discount . . . for insured treatment that [they] would apply to charges incurred by a policyholder of its most favored insurer.&rdquo;</li>
	  <li>Hospitals must adopt a zero-tolerance policy for abusive, harassing, oppressive, or misleading language or collections conduct when collecting medical debts.Â </li>
    </ul>
    
    <p>The settlement with Hutchinson Hospital requires Hutchinson to provide the affected patients with the lowest available monthly payment to which they are entitled between their old and new monthly payment amounts, and prevents Hutchinson from deactivating payment plans of patients in the future.Â Â The settlement further prevents Hutchinson from establishing a new payment plan policy that has the effect of increasing the monthly payments of then-existing payment plans. Hutchinson is also prohibited from erroneously threatening patients with collections for failing to pay their medical bills. Hutchinson is subject to a $25,000 civil penalty if it violates the terms of the settlement.Â Â Â </p>
    
    <p>If you think you have been the victim of unfair or unreasonable medical billing or debt collection practices, please refer to the Attorney General&rsquo;s publicationsÂ <em>Medical Billing PointersÂ </em>andÂ <em>Debt Collection Fact Sheet</em>, available on the Attorney General&rsquo;s website atÂ <a href="https://www.ag.state.mn.us/Office/Publications.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">https://www.ag.state.mn.us/Office/Publications.asp</a>. Â </p>
    
    <p>You may also submitÂ an online complaint form on the Attorney General&rsquo;s website atÂ <a href="http://www.ag.state.mn.us/Office/Complaint.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">www.ag.state.mn.us/Office/Complaint.asp</a>Â or by contacting the office at:Â Â </p>
    <p class="center"><strong>Office of Minnesota Attorney General Keith EllisonÂ </strong><br>
    445 Minnesota Street, Suite 600Â <br>
    St. Paul, MN 55101Â <br>
    (651) 596-3353 (MinneapolisâSaint Paul metro area)Â <br>
    (800) 657-3787 (Greater Minnesota)</p>
