...
<meta name="description" content="Attorney General Ellison Announces $1.85 Billion Settlement with Student Loan Servicer Navient">
...
<meta name="twitter:title" content="Attorney General Ellison Announces $1.85 Billion Settlement with Student Loan Servicer Navient " />
<meta name="twitter:description" content="Settlement includes Significant Changes to Servicing and Lending Practices; $1.7 billion in debt cancellation and $95 million in restitution nationwide; and Additional Monetary Payments" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2022/01/13_Navient.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison Announces $1.85 Billion Settlement with Student Loan Servicer Navient"/>
<meta property="og:description" content="Settlement includes Significant Changes to Servicing and Lending Practices; $1.7 billion in debt cancellation and $95 million in restitution nationwide; and Additional Monetary Payments" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>January 13, 2022 Press Release</title>
...
<h1>Attorney General Ellison Announces $1.85 Billion Settlement with Student Loan Servicer Navient</h1>


<p class="lede">Settlement includes Significant Changes to Servicing and Lending Practices; $1.7 billion in debt cancellation and $95 million in restitution nationwide; and Additional Monetary Payments</p>
<p class="lede">Minnesota student loan borrowers will receive over $14 million in total financial relief. </p>



	
<p><strong>January 13, 2022 (SAINT PAUL)</strong>Â <strong>â</strong>Â Attorney General Keith Ellison announced today thatÂ Navient, known as one of the nation&rsquo;s largest student loan servicers, will provide relief totaling $1.85 billion, including $14 million to Minnesota students, to resolve allegations of widespread unfair and deceptive student loan servicing practices and abuses in originating predatory student loans.Â Â </p>
<p>This settlement, joined by a coalition of 39 attorneys general, resolves claims that since 2009, despite representing that it would help borrowers find the best repayment options for them,Â Navient steered struggling student loan borrowers into costly long-term forbearances instead of counseling them about the benefits of more affordable income-driven repayment plans.Â </p>

<p>&ldquo;Navient put their own profits ahead of the interests of millions of families across our country who are struggling to repay student loans,&rdquo; saidÂ <strong>Attorney General Ellison</strong>. &ldquo;Minnesota students and parents cannot afford to be cheated out of money simply because Navient knew how to game the system. Today, we held Navient accountable and will continue to protect Minnesotans against businesses that put their bottom line ahead of the interests of their customers and consumers.&rdquo;Â </p>

<p>Attorney General Ellison will file the settlement as a proposed Consent JudgmentÂ in Ramsey County District Court. The settlement will require court approval.Â </p>

<p>According to the attorneys general, the interest that accrued because ofÂ Navient&rsquo;s forbearance steering practices was added to the borrowers&rsquo; loan balances, pushing borrowers further in debt. Had the company instead provided borrowers with the help it promised, income-driven repayment plans could have potentially reduced payments to as low as $0 per month, provided interest subsidies, and/or helped attain forgiveness of any remaining balance after 20-25 years of qualifying payments (or 10 years for borrowers qualified under the Public Service Loan Forgiveness Program).Â </p>

<p>Navient also allegedly originated predatory subprime private loans to students attending for-profit schools and colleges with low graduation rates, even though it knew that a very high percentage of such borrowers would be unable to repay the loans.Â Navient allegedly made these risky subprime loans as &ldquo;an inducement to get schools to useÂ Navient as a preferred lender&rdquo; for highly-profitable federal and &ldquo;prime&rdquo; private loans, without regard for borrowers and their families, many of whom were knowingly ensnared in debts they could never repay.Â </p>

<p>Under the terms of the settlement,Â Navient will cancel the remaining balance on nearly $1.7 billion in subprime private student loan balances owed by approximately 66,000 borrowers nationwide.Â A total of $95 million in restitution payments of about $260 each will be distributed to approximately 350,000 federal loan borrowers who were placed in certain types of long-term forbearances. Borrowers who will receive restitution or debt cancellation span all generations: Navient&rsquo;s harmful conduct impacted everyone from students who enrolled in colleges and universities immediately after high school to mid-career students who dropped out after enrolling in a for-profit school in the early.Â </p>
<p>As part of the settlement, Minnesota will receive a total of $1.14 million in restitution payments for 4,325 federal loan borrowers. Additionally, 432 Minnesota borrowers will receive nearly $13Â million in private loan debt cancellation, equating to roughly $30,000 in cancelled student loans per borrower.Â </p>

<p>The settlement also includes important conduct reforms that requireÂ Navient to explain the benefits of income-driven repayment plans and to offer to estimate income-driven payment amounts before placing borrowers into optional forbearances. Additionally,Â Navient must train specialists who will advise distressed borrowers concerning alternative repayment options and counsel public service workers concerning Public Service Loan Forgiveness (PSLF) and related programs. The conduct reforms imposed by the settlement include prohibitions on compensating customer service agents in a manner that incentivizes them to minimize time spent counseling borrowers.Â Â </p>
<p>The settlement also requiresÂ Navient to notify borrowers about the U.S. Department of Education&rsquo;s recently announced <a href="https://studentaid.gov/announcements-events/pslf-limited-waiver" target="_blank">PSLF limited waiver opportunity</a>, which temporarily offers millions of qualifying public service workers the chance to have previously nonqualifying repayment periods counted toward loan forgivenessâprovided that they consolidate into the Direct Loan Program and file employment certificationsÂ <strong>by October 31, 2022</strong>.Â </p>

<p>As a result of today&rsquo;s settlement, borrowers receiving private loan debt cancellation will receive a notice fromÂ Navient, along with refunds of any payments made on the cancelled private loans after June 30, 2021. Federal loan borrowers who are eligible for a restitution payment of approximately $260 will receive a postcard in the mail from the settlement administrator later this spring.Â </p>

<p><strong>Federal loan borrowers who qualify for relief under this settlement do not need to take any action except update or create their studentaid.gov account to ensure U.S. Department of Education has their current address.</strong>Â For more information, visit <a href="http://www.navientagsettlement.com/" target="_blank">www.NavientAGSettlement.com</a><u>.</u>Â </p>
