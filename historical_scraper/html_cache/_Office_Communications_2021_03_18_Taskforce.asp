...
<meta name="description" content="Attorney General Keith Ellison joins nationwide task force on pharmaceutical mergers">
...
<meta name="twitter:title" content="Attorney General Keith Ellison joins nationwide task force on pharmaceutical mergers" />
<meta name="twitter:description" content="Lowering cost of prescription drugs and ensuring fair marketplace among AG Ellisonâs top priorities; new task force meets recommendation of AGâs report on report on drug prices" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2021/03/18_Taskforce.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Keith Ellison joins nationwide task force on pharmaceutical mergers" />
<meta property="og:description" content="Lowering cost of prescription drugs and ensuring fair marketplace among AG Ellisonâs top priorities; new task force meets recommendation of AGâs report on report on drug prices" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>March 18, 2021 Press Release</title>
...
<h1>Attorney General Keith Ellison joins nationwide task force on pharmaceutical mergers</h1>


<p class="lede">Lowering cost of prescription drugs and ensuring fair marketplace among AG Ellisonâs top priorities; new task force meets recommendation of AGâs report on report on drug prices</p>


	<p><strong>March 18, 2021 (SAINT PAUL)</strong>Â â Minnesota Attorney General Ellison today announced today that he is joining a nationwide task force of state attorneys general in response to the &ldquo;Reimagining Pharmaceuticals Initiative,&rdquo; led by the Federal Trade Commission (FTC), to update the national and international approach to analyzing the effects of pharmaceutical mergers. Â </p>
	
	<p>&ldquo;No one should have to choose between affording their lives and affording to live, but mergers in the pharmaceutical industry can make it impossible for people to afford the drugs that they need to live,&rdquo; Attorney General Ellison said. &ldquo;Lowering pharmaceutical drug prices and ensuring that federal and state governments have the antitrust tools we need to ensure a fair, competitive economy are two of my top priorities. This task force will help move those goals forward. I look forward sharing the steps we&rsquo;ve taken in Minnesota with this national task force.&rdquo;Â </p>
	
	<p>In February 2020, Attorney General Ellison&rsquo;s year-long, bipartisanÂ <a href="https://www.ag.state.mn.us/Office/Initiatives/PharmaceuticalDrugPrices/Taskforce.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">Advisory Task Force on Lowering Pharmaceutical Drug Prices</a>Â released a nearly 100-pageÂ <a href="https://www.ag.state.mn.us/Office/Initiatives/PharmaceuticalDrugPrices/Taskforce.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">report and recommendations</a>Â for lowering drug prices. Notably, the report shed light on the dysfunctional nature of a highly complex and opaque pharmaceutical-drug market and the principal factors that contribute to a lack of transparency about prices and a lack of accountability for driving prices higher and higher. Â </p>
	
	<p>One of the report&rsquo;s recommendations (recommendation 5.6, p. 60) is to &ldquo;strengthen laws targeting anticompetitive behavior in the drug industry.&rdquo; One of that recommendation&rsquo;s action steps (5.6.4) is that &ldquo;Federal and state regulators should increase enforcement resources dedicated to reviewing mergers in the drug industry and blocking those that are anticompetitive.&rdquo; The FTC task force that Attorney General Ellison has joined helps meet that recommendation.Â </p>
	
	<p>The Reimagining Pharmaceuticals task force is a multistate working group, chaired by the attorneys general of California, Pennsylvania, and Wisconsin, that will report its findings to the FTC as part of its &ldquo;Reimagining Pharmaceuticals Initiative.&rdquo;Â </p>
	
	<p>The FTC Initiative taps expertise from competition authorities with whom the FTC cooperates frequently, as well as others with relevant experience, to ensure the most effective enforcement in these crucial markets. The goal of this initiative is to identify concrete and actionable steps to review and update the analysis of pharmaceutical mergers. This project will ensure that FTC investigations include fresh approaches that fully analyze and address the varied competitive concerns that these mergers and acquisitions raise.Â Â Â </p>
	
	<p>&ldquo;Given the high volume of pharmaceutical mergers in recent years, amid skyrocketing drug prices and ongoing concerns about anticompetitive conduct in the industry, it is imperative that we rethink our approach toward pharmaceutical merger review,&rdquo; said FTC Acting Chair Rebecca Kelly Slaughter. &ldquo;Working hand in hand with international and domestic enforcement partners, we intend to take an aggressive approach to tackling anticompetitive pharmaceutical mergers.&rdquo;Â </p>
	
	<p>Among the questions the task force will consider are: Â </p>
	
	<ul>
	  <li>How can current theories of harm be expanded and refreshed?Â </li>
	  <li>What is the full range of a pharmaceutical merger&rsquo;s effects on innovation?Â </li>
	  <li>In merger review, how should we consider pharmaceutical conduct such as price fixing, reverse payments, and other regulatory abuses?Â </li>
	  <li>What evidence would be needed to challenge a transaction based on any new or expanded theories of harm? Â </li>
	  <li>What types of remedies would work in the cases to which those theories are applied? Â </li>
	  <li>What have we learned about the scope of assets and characteristics of firms that make successful divestiture buyers?Â </li>
    </ul>
