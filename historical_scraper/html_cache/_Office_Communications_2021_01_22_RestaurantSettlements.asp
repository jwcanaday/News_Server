...
<meta name="description" content=" State settles with restaurants that violated executive orders ">
...
<meta name="twitter:title" content=" State settles with restaurants that violated executive orders " />
<meta name="twitter:description" content="Cork in Anoka will fully comply with executive orders, agrees to 15-day liquor license suspension; Neighbors on the Rum in Princeton also to fully comply with executive orders  " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2021/01/22_RestaurantSettlements.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content=" State settles with restaurants that violated executive orders " />
<meta property="og:description" content="Cork in Anoka will fully comply with executive orders, agrees to 15-day liquor license suspension; Neighbors on the Rum in Princeton also to fully comply with executive orders   " />
...
<h1> State settles with restaurants that violated executive orders</h1>
	<p class="lede">Cork in Anoka will fully comply with executive orders, agrees to 15-day liquor license suspension; Neighbors on the Rum in Princeton also to fully comply with executive orders</p>



	<p><strong>January 22, 2020 (SAINT PAUL)</strong>Â â The State of Minnesota has settled with two restaurants â Cork in Anoka and Neighbors on the Rum in Princeton â for violations of the previous ban on indoor, on-premises dining in Governor Tim Walz&rsquo;sÂ <a href="https://mn.gov/governor/assets/EO%2020-99%20Final%20%28003%29_tcm1055-454294.pdf" target="_blank">Executive Order 20-99</a>Â and related executive orders.Â </p>
	
	<ul>
	  <li>Per the terms of aÂ <a href="https://www.ag.state.mn.us/office/Communications/2020/docs/Cork_ConsentJudgment.pdf" target="_blank">consent judgment</a>Â with the office of Minnesota Attorney General Keith Ellison filed in Anoka County, Anoka-based Cork will fully comply with the requirements of Governor Tim Walz&rsquo;s current and future executive orders that apply to restaurants and/or bars while those executive orders are fully effective.Â If Cork violates any of the terms of the consent judgment, it is liable for a civil penalty of $25,000 to the State of Minnesota.Â </li>
	  <li>Per the terms of a settlement with the Alcohol and Gambling Enforcement Division of the Department of Public Safety, CorkÂ has also agreed to a 15-day liquor license suspension. Cork&rsquo;s liquor license expired on January 1, 2021, and the establishment has not taken steps to renew it. If Cork reapplies for a liquor license, the license will be suspended for the first 15 days after it is approved. Cork also agrees to comply with any future executive orders.Â </li>
	  <li>Per the terms of aÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/docs/NeighborsTwoInc_ConsentJudgment.pdf" target="_blank">consent judgment</a>Â with the Attorney General&rsquo;s office filed in Mile Lacs County, Princeton-based Neighbors on the Rum will fully comply with the requirements of Governor Tim Walz&rsquo;s current and future executive orders that apply to restaurants and/or bars while those executive orders are fully effective. Like Cork, if Neighbors on the Rum violates any of the terms of the consent judgment, it is liable for a civil penalty of $25,000 to the State of Minnesota.Â </li>
    </ul>
	
	<p>On December 18, 2020, Attorney General Ellison&rsquo;s officeÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/12/18_EnforcementActions.asp" target="_blank">sued Cork</a>Â for openly violating the ban on indoor on-premises dining in Governor Tim Walz&rsquo;s Executive Order 20-99. On December 21, the office filed for aÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/12/21_RestaurantTROs.asp" target="_blank">temporary restraining order</a>Â against Cork. On December 17, 2020, Attorney General Ellison&rsquo;s officeÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/12/17_RestaurantViolations.asp" target="_blank">sued Neighbors on the Rum</a>Â for violating the same ban in Executive Order 20-99. The office did not file for a temporary restraining order against Neighbors on the Rum because it voluntarily complied with the executive order upon being sued.Â </p>
	
	<p>&ldquo;I want to thank Cork and Neighbors on the Rum for meeting their responsibility to help all Minnesotans stop the spread of COVID-19 and congratulate it on rejoining the vast majority of Minnesota bars and restaurants that are already doing so,&rdquo; Attorney General Ellison said. &ldquo;It brought me no joy to bring these enforcement action and I am happy to resolve them in a way that helps keep more Minnesotans safe from this deadly virus.Â </p>
	
	<p>&ldquo;Our top priority has always been education and voluntarily compliance. Enforcement has always been a last resort,&rdquo; Attorney General Ellison continued. &ldquo;This settlement can be a sign to the very small handful of establishments that are violating the executive order that compliance is still available to them.&rdquo;Â </p>
	
	<p>These represent the second and third settlement the Attorney General&rsquo;s office has reached with establishments against which it had filed enforcement actions for violating the terms of Executive Orders 20-99 and 20-103. On January 12, 2021, Attorney General Ellison&rsquo;s officeÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/01/12_Cornerstone.asp" target="_blank">settled its lawsuit against Cornerstone CafÃ© in Monticello</a>.Â </p>
	
	<p>Attorney General Ellison&rsquo;s office and State agencies such as the Department of Public Safety and the Department of Health have a variety ofÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/01/08_EO_Enforcement_Update.asp" target="_blank">enforcement tools</a>Â available to enforce relevant parts of the Governor&rsquo;s executive orders related to stopping the spread of COVID-19.Â Â The Governor&rsquo;sÂ <a href="https://www.revisor.mn.gov/statutes/cite/12.32" target="_blank">executive orders have the force and effect of law</a>Â during the peacetime emergency.Â </p>
