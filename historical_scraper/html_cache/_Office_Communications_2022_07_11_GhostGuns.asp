...
<meta name="description" content="Attorney General Ellison intervenes in court to regulate ghost guns">
...
<meta name="twitter:title" content="Attorney General Ellison intervenes in court to regulate ghost guns" />
<meta name="twitter:description" content="Joins coalition of 20 AGs to support new, commonsense federal regulation under attack by Texas gun-parts distributor " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2022/07/11_GhostGuns.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison intervenes in court to regulate ghost guns   "/>
<meta property="og:description" content="Joins coalition of 20 AGs to support new, commonsense federal regulation under attack by Texas gun-parts distributor " />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>July 11, 2022 Press Release</title>
...
<h1>Attorney General Ellison intervenes in court to regulate ghost guns   </h1>


<p class="lede">Joins coalition of 20 AGs to support new, commonsense federal regulation under attack by Texas gun-parts distributor</p>
<p class="lede">Amid epidemic of gun violence, latest step by AG Ellison to stop proliferation of ghost guns</p>




  <p><strong>July 11, 2022 (SAINT PAUL)Â </strong>â In his latest step to stop the dangerous proliferation of ghost guns in Minnesota and nationally, Minnesota<strong>Â </strong>Attorney General Keith Ellison today joined a coalition of 20 attorneys general in filing anÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/docs/Division80_MultistateAmicusBrief.pdf" target="_blank">amicus brief</a>Â in support of an important new Biden Administration rule regulating &ldquo;ghost guns.&rdquo; Ghost guns are untraceable lethal weapons that can be made at home from weapon-parts kits that anyone â including felons, juveniles, and domestic abusers who are legally prohibited from possessing guns â can purchase online without background checks. Despite the obvious risk of ghost guns to public safety and the obvious benefits of regulating them, a Texas-based gun-parts distributor has sued in federal court in Texas to block the rule from taking effect, prompting Attorney General Ellison and the coalition to intervene.Â </p>
 
  <p>&ldquo;My job is to protect Minnesotans. In the current epidemic of gun violence, ghost guns are a major threat to Minnesotans&rsquo; safety,&rdquo; Attorney General Ellison said. &ldquo;The vast majority of Minnesotans, like the vast majority of Americans everywhere, want common-sense regulation of dangerous weapons, like requiring background checks and waiting periods and making sure that law enforcement can track illegal guns. I asked the Biden Administration to regulate ghost guns and they agreed. Now I&rsquo;m outraged this rule is being challenged in court. I&rsquo;m not going to sit back and let a greedy Texas gun-parts distributor get in the way of keeping Minnesotans safe from unregulated, untraceable, and deadly ghost guns,&rdquo; Attorney General Ellison concluded.Â </p>
  
  <p>The common-sense final rule of the Bureau of Alcohol, Tobacco and FirearmsÂ defines the key building blocks for ghost guns â weapon-parts kits and partially complete frames or receivers â as &ldquo;firearms&rdquo; under the federal Gun Control Act if they can be readily converted to function as such. In so doing, the final rule helps close a dangerous loophole in firearms regulation that enabled people to evade existing gun-safety laws and get their hands on these dangerous weapons.Â It helps ensure that buyers pass background checks before being able to purchase ghost-gun kits and that law enforcement officers can trace any self-made guns that are later used in a crime. It also limits gun traffickers&rsquo; ability to distribute these dangerous weapons. Â </p>
 
  <p>Recent years have seen a dramatic proliferation of ghost guns. Nationally, law enforcement officers recovered 1,700Â self-made guns in 2016, but more than 19,000 in 2021, an eleven-fold increase.Â Â In that five-year period, officers recovered more than 45,000 self-made guns nationally â more than 40 percent of which were recovered in 2021 alone. (See p. 10 of the brief.) Law enforcement officials in Minnesota anecdotally report a similarly sharp increase in ghost guns recovered in recent years.Â </p>
  
  <h2>Attorney General Ellison&rsquo;s actions to halt proliferation of ghost gunsÂ </h2>
  
  <p>Today&rsquo;s amicus brief is the latest action Attorney General Ellison has taken to halt or regulate the proliferation of ghost guns.Â </p>
  
  <ul>
    <li>OnÂ <a href="https://www.atg.wa.gov/news/news-releases/ag-ferguson-leads-multistate-lawsuit-over-new-trump-administration-effort-allow" target="_blank">January 23, 2020</a>, Attorney General Ellison joined a coalition of 21 attorneys general suing the Trump Administration to stop itsÂ effort to allow 3D-printed gun files to be released on the internet. OnÂ <a href="https://www.atg.wa.gov/news/news-releases/judge-blocks-new-trump-administration-effort-allow-release-3d-printed-ghost-guns" target="_blank">March 9, 2020</a>, a federal judge granted the coalition&rsquo;s request for an injunction blocking the regulation that would have allowed release of the files.Â Â </li>
    <li>OnÂ <a href="https://oag.dc.gov/release/ag-racine-leads-19-state-coalition-arguing-atf-has" target="_blank">December 17, 2020</a>, Attorney General Ellison joined a coalition of 19 attorneys general in an amicus brief to compel the Trump Administration to regulate ghost guns.Â </li>
    <li>OnÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/docs/3Dguns_MultistateLtr.pdf" target="_blank">February 25, 2021</a>, Attorney General Ellison joined a coalition of 19 attorneys general in a letter asking President Biden to intervene to stop the deregulation of ghost guns.Â </li>
    <li>OnÂ <a href="https://www.attorneygeneral.gov/taking-action/ag-shapiro-to-u-s-attorney-general-garland-firearm-regulations-must-include-ghost-guns/" target="_blank">August 19, 2021</a>, Attorney General Ellison joined a coalition of 22 attorneys general in a letter to U.S. Attorney General Merrick Garland encouragingÂ the ATF to finalize regulations that would make clear that &ldquo;ghost guns&rdquo; are firearms under federal law.Â This is the same final rule that Attorney General Ellison filed the amicus brief today to support.Â </li>
  </ul>
  <p>A 2022 bill (<a href="https://www.revisor.mn.gov/bills/text.php?number=HF4014&type=bill&version=0&session=ls92&session_year=2022&session_number=0" target="_blank">HF 4014</a>/SF 3378, Sec. 18) that would make manufacturing, selling, purchasing, or possessing a ghost gun or undetectable firearm a felony in MinnesotaÂ <a href="https://www.revisor.mn.gov/bills/bill.php?b=house&f=HF4014&ssn=0&y=2022" target="_blank">did not receive a hearing</a>Â in either house of the Minnesota Legislature.Â   
  <p> Joining Attorney General Ellison in filing theÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/docs/Division80_MultistateAmicusBrief.pdf" target="_blank">amicus brief</a>Â today was District of Columbia Attorney General Karl Racine, who led the brief along with the attorneys general of New Jersey and Pennsylvania, and the attorneys general of California, Colorado, Connecticut, Delaware, Hawaii, Illinois, Maine, Maryland, Massachusetts, Michigan, New York, North Carolina, Oregon, Rhode Island, Washington, and Wisconsin.</p>
