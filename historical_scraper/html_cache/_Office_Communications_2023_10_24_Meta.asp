...
<meta name="description" content="Bipartisan coalition of attorneys general file lawsuits against Meta for harming youth mental health through its social media platforms">
...
<meta name="twitter:title" content="Bipartisan coalition of attorneys general file lawsuits against Meta for harming youth mental health through its social media platforms" />
<meta name="twitter:description" content="AG Ellison joins 33 bipartisan attorneys general in federal lawsuit; eight more sue in state courts" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2023/10/24_Meta.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Bipartisan coalition of attorneys general file lawsuits against Meta for harming youth mental health through its social media platforms"/>
<meta property="og:description" content="AG Ellison joins 33 bipartisan attorneys general in federal lawsuit; eight more sue in state courts" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>October 24, 2023 Press Release</title>
...
<div id="browseMobile" class="hide-on-desktop">
 ...
 <div id="content">
   ...
   <h1 align="center">Bipartisan coalition of attorneys general file lawsuits against Meta for harming youth mental health through its social media platforms  </h1>
   <p class="lede">AG Ellison joins 33 bipartisan attorneys general in federal lawsuit; eight more sue in state courts</p>

   


         <p><strong>October 24, 2023 (SAINT PAUL) âÂ </strong>Today, Minnesota Attorney General Keith EllisonÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/docs/Meta_Complaint.pdf">joined a bipartisan coalition of 42 attorneys general throughout the country in suing Meta</a>, the parent company of Facebook and Instagram, in both federal and state courts, alleging that the company knowingly designed and deployed harmful features on Instagram and its other social media platforms that purposefully addict children and teens. At the same time, Meta falsely assured the public that these features are safe and suitable for young users.</p>
         
         <p>&ldquo;It&rsquo;s my job to protect Minnesotans, especially the most vulnerable. Meta is very intentionally trying to manipulate our children and teens into spending as much time on their platforms as possible, despite knowing this is causing serious harm,&rdquo; said Attorney General Ellison. &ldquo;Meta&rsquo;s efforts to addict our young people and sacrifice their well-being for engagement is disgraceful, predatory, and illegal. I&rsquo;m joining a bipartisan coalition of attorneys general to hold them accountable for it.&rdquo;</p>
         
         <p>Attorney General Ellison joined a federal complaint with a total of 33 states that was filed in U.S. District Court for the Northern District of California. Attorney General Ellison and the bipartisan coalition assert that Meta&rsquo;s business practices violate state consumer protection laws and the federal Children&rsquo;s Online Privacy Protection Act (COPPA). These practices have harmed and continue to harm the physical and mental health of children and teens and have fueled what the U.S. Surgeon General hasÂ <a href="https://www.hhs.gov/sites/default/files/sg-youth-mental-health-social-media-advisory.pdf">deemed</a>Â a &ldquo;youth mental health crisis&rdquo; that has ended lives, devastated families, and damaged the potential of a generation of young people.</p>
         
         <p>Attorney General Ellison and the coalition further allege that Meta knew of the harmful impact of its platforms, including Facebook and Instagram, on young people. Instead of taking steps to mitigate these harms, it misled the public about the harms associated with use of its platform, concealing the extent of the psychological and health harms suffered by young users addicted to use of its platforms. The complaint further alleges that Meta knew that young users, including those under 13, were active on the platforms, and knowingly collected data from these users without parental consent. It targeted these young users noting, as reported in a 2021Â <a href="https://www.wsj.com/articles/facebook-instagram-kids-tweens-attract-11632849667">Wall Street Journal article</a>, that such a user base was &ldquo;valuable, but untapped.&rdquo;</p>
         
         <p>While much of the complaint relies on confidential material that is not yet available to the public, publicly available sources â including those previously released by former Meta employees â detail that Meta profited by purposely making its platforms addictive to children and teens. Its platform algorithms push users into descending &ldquo;rabbit holes&rdquo; in an effort to maximize engagement. Features like infinite scroll and near-constant alerts were created with the express goal of hooking young users. These manipulative tactics continually lure children and teens back onto the platform. As Aza Raskin, the original developer of the infinite scroll concept,Â <a href="https://www.bbc.com/news/technology-44640959">noted to the BBC</a>Â about the feature&rsquo;s addictive qualities: &ldquo;If you don't give your brain time to catch up with your impulses, . . . you just keep scrolling.&rdquo;</p>
         
         <p>Meta knew these addictive features harmed young people&rsquo;s physical and mental health, including undermining their ability to get adequate sleep, but did not disclose the harm, nor did they make meaningful changes to minimize the harm. Instead, they claimed their platforms were safe for young users.</p>
         
         <p>These choices, Attorney General Ellison and the bipartisan coalition allege, violate state consumer protection laws and COPPA. The federal complaint of which Minnesota is a part seeks injunctive and monetary relief to rectify the harms these platforms caused.</p>
         
         <p>In parallel complaints filed in state courts today, eight states have made similar allegations. Tennessee&rsquo;s state complaint, for example, is seeking injunctive and monetary relief for Instagram&rsquo;s unfair and deceptive acts. It alleges that Meta designed Instagram to be addictive, purposefully targeted children and teens, and took advantage of their biologically limited capacity for self-control. Meta knew, the complaint alleges, of the wide range of harms compulsive use caused, including increased levels of depression, anxiety, and attention deficit disorders; altered psychological and neurological development; and reduced sleep. Yet, the company continued to assure the public Instagram was safe and concealed the known significant risks of the platform.</p>
         
         <p>These lawsuits are the result of a bipartisan, nationwide investigation led by Colorado Attorney General Phil Weiser and Tennessee Attorney General Jonathan Skrmetti, which Attorney General Ellison announcedÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/11/18_Meta.asp">Minnesota joined in November 2021</a>. Nearly all the attorneys general in the country have worked together since 2021 to investigate Meta for providing and promoting its social media platforms to children and young adults while use is associated with physical and mental health harms. While some states have pursued litigation in state court and others in collective federal action, the attorneys general will continue to work together as the litigation continues.</p>
         
         <p>Attorney General Ellison and the bipartisan, multistate coalition that brought today&rsquo;s complaint areÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/03/02_TikTok.asp">also investigating TikTok&rsquo;s conduct on a similar set of concerns</a>. That investigation remains ongoing. Attorney General Ellison&rsquo;s office and the coalition have pushed for adequate disclosure of information and documents in litigation related to TikTok&rsquo;s failure to provide adequate discovery in response to requests by the Tennessee Attorney General&rsquo;s office.</p>
         
         <p>Joining Attorney General Ellison in filing today&rsquo;s federal lawsuit against Meta are the attorneys general of Arizona, California, Colorado, Connecticut, Delaware, Georgia, Hawaii, Idaho, Illinois, Indiana, Kansas, Kentucky, Louisiana, Maine, Maryland, Michigan, Missouri, Nebraska, New Jersey, New York, North Carolina, North Dakota, Ohio, Oregon, Pennsylvania, Rhode Island, South Carolina, South Dakota, Virginia, Washington, West Virginia, and Wisconsin. Florida is filing its own federal lawsuit in the U.S. District Court for the Middle District of Florida.</p>
         
         <p>Filing lawsuits in their own state courts are the attorneys general of the District of Columbia, Massachusetts, Mississippi, New Hampshire, Oklahoma, Tennessee, Utah, and Vermont.</p>
