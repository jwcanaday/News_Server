...
<meta name="description" content="Attorney General Ellison asks court to remove trustees of Otto Bremer Trust ">
...
<meta name="twitter:title" content="Attorney General Ellison asks court to remove trustees of Otto Bremer Trust" />
<meta name="twitter:description" content="Petition details reckless attempt to sell Trustâs shares in Bremer Financial Corporation, knowing it would set off a âcascade of unfortunate consequencesâ" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2020/08/12_OttoBremerTrust.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison asks court to remove trustees of Otto Bremer Trust " />
<meta property="og:description" content="Petition details reckless attempt to sell Trustâs shares in Bremer Financial Corporation, knowing it would set off a âcascade of unfortunate consequencesâ" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>August 12, 2020 Press Release</title>
...
<h1>Attorney General Ellison asks court to remove trustees of Otto Bremer Trust </h1>
	<p class="lede">Petition details reckless attempt to sell Trustâs shares in Bremer Financial Corporation, knowing it would set off a âcascade of unfortunate consequencesâ</p>
	<p class="lede">Petition alleges a pattern of serious breaches, including self-dealing, excessive compensation and spending, hostile work environment, and shift in focus of trust from charitable to financial purposes </p>

	<p><strong>August 12, 2020 (SAINT PAUL) â</strong>Â After a months-longÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/01/13_OttoBremerTrust.asp" target="_blank" >investigation</a>, Minnesota Attorney General Keith Ellison today asked a court to remove the trustees of the Otto Bremer Trust (OBT), Brian Lipschultz, Daniel Reardon, and Charlotte Johnson.Â Â Â Â </p>
	
	<p><a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/OttoBremerTrust_PetitionForRemoval.pdf" target="_blank" >Two</a>Â <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/OttoBremerTrust_InterimPetition.pdf" target="_blank" >petitions</a>Â and an associatedÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/OttoBremerTrust_Memorandum.pdf" target="_blank" >memorandum of law</a>Â filed in Ramsey County Probate Court today detail the trustees&rsquo; serious breaches of fiduciary duty, their longstanding failure to administer the trust effectively and in accordance with the directives of its founder, and multiple violations of state laws governing charitable trusts â culminating in a reckless hostile takeover attempt of the OBT&rsquo;s primary asset, Bremer Financial Corporation (BFC), in October 2019. Â </p>
	
	<p>The petition does not weigh in on BFC&rsquo;s or any other party&rsquo;s claims or conduct. Attorney General Ellison is, however, simultaneously asking the court to stay the lawsuits between the trustees and the BFC-related parties until his petition is decided.Â </p>
	
	<p>&ldquo;Minnesotans care about and for each other: they want each other to be able to afford their lives and live with dignity and respect, just as they want for themselves. Minnesotans trust charitable trusts to play an important role in that goal. Otto Bremer directed that the trust in his name not be used for &lsquo;any purpose&rsquo; other than charitable. The trustees&rsquo; actions have abused his trust and Minnesotans&rsquo; trust,&rdquo; Attorney General Ellison said.Â </p>
	
	<p>&ldquo;I do not take this action lightly,&rdquo; Attorney General Ellison continued. &ldquo;But as the chief law officer of the state and supervisor of charitable trusts in Minnesota, I have the duty to make sure charitable assets are used properly and for the benefit of the public, not the private aims and personal enrichment of the trustees. Because the trustees&rsquo; misconduct is particularly serious, it requires particularly serious action by my Office.&rdquo;Â </p>
	
	<p>The mission that Otto Bremer set for the trust, as outlined in the trust instrument, includes to &ldquo;relieve poverty in the City of St. Paul, Minnesota,&rdquo; &ldquo;establish scholarship and assist poor and deserving children in securing education, to &ldquo;promote citizenship, to &ldquo;promote the public health, and to &ldquo;aid persons suffering from catastrophe,&rdquo; among other aims.Â </p>
	
	<p>Attorney General Ellison brings this action today under the power and authority the Legislature has conferred on the Attorney General to supervise and regulate nonprofits, as the chief law officer of the state, and as the representative of public&rsquo;s interest in charitable trusts, of which the public is the beneficiary.Â </p>
	
	<p>The petition details how the trustees acted recklessly in their attempt to sell the trust&rsquo;s BFC shares to a large number of out-of-state hedge funds, knowing it would trigger, in their words, &ldquo;a cascade of unfortunate consequences.&rdquo; Trustees&rsquo; attempt to engineer the sale of the bank enriched them significantly, exposed OBT to significant legal risk, and drained the trust of millions of dollars in expenses that should have been available for the charitable purposes of the trust. In the course of attempting to engineer the sale, contrary to the wishes of trust founder Otto Bremer as expressed in the instrument that governs OBT, trustees also withheld important information from the Attorney General&rsquo;s Office so that the Office would not block their plans. By so doing, they attempted to undermine the legal authority of the Attorney General&rsquo;s Office to ensure that OBT and all charitable trusts operate in strict accordance with the law.Â </p>
	
	<p>The 2019 sale followed a years-long attempt to reframe OBT&rsquo;s &ldquo;brand&rdquo; from a charitable foundation to a finance-focused private-equity firm benefiting their private interests.Â Â Across numerous aspects of the trust, the trustees elevated their own interests above serving its charitable purposes, including by: making self-interested grants to promote their status in the community, including million-dollar grants to charities with which they were personally affiliated; creating a hostile work environment for employees that exposed the trust to liability and created a universal fear of retaliation among employees; misusing charitable assets and self-dealing to run unrelated private businesses out of OBT&rsquo;s offices; spending excessively on lavish office space and other overhead; paying themselves to redundant and unnecessary fees; significantly raising their own compensation without a corresponding rise in their duties; and creating and not remedying deficiencies in governance and oversight. Â </p>
	
	<p>The petition requests that the court remove the trustees and appoint new fiduciaries to investigate the allegations, manage the trust, and rebuild independent oversight over the trust.Â Â It also seeks immediate remedies, including trustees&rsquo; immediate suspension or removal, to prevent ongoing harm to the trust like illegal investments, restructuring the trust to shield it from oversight and liability, and incurring tens of millions of dollars in legal fees. Â </p>
	
	<p>Attorney General Ellison is proposing that the court appointÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/OttoBremerTrust_Affidavit_Alexander.pdf" target="_blank" >Pamela Alexander</a>,Â <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/OttoBremerTrust_Affidavit_Avner.pdf" target="_blank" >Marcia Avner</a>, andÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/OttoBremerTrust_Affidavit_Rhodes.pdf" target="_blank" >Carleen Rhodes</a>Â as interim trustees. Ms. Alexander is a retired judge of Hennepin County District Court, Ms. Avner is a former public policy director of the Minnesota Council on Nonprofits, and Ms. Rhodes is the former president and CEO of The Saint Paul Foundation and the Minnesota Community Foundation.Â </p>
	<p>The Court File Number for the case isÂ 62-C9-61-315222.</p>
