...
<meta name="description" content="Federal appeals court rules Stateâs climate-change deception lawsuit can proceed in state court">
...
<meta name="twitter:title" content="Federal appeals court rules Stateâs climate-change deception lawsuit can proceed in state court" />
<meta name="twitter:description" content="In decision today, 8th Circuit Court of Appeals rules against defendants, upholds U.S. District Court remand of lawsuit to state court where it was originally filed" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2023/03/23_EnergyCompanies.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Federal appeals court rules Stateâs climate-change deception lawsuit can proceed in state court"/>
<meta property="og:description" content="In decision today, 8th Circuit Court of Appeals rules against defendants, upholds U.S. District Court remand of lawsuit to state court where it was originally filed" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>March 23, 2023 Press Release</title>
...
<div id="sideBar"class="hide-on-mobile hide-on-tablet">
 ...
 <div id="content">
   ...
   <h1 align="center"> 
Federal appeals court rules Stateâs climate-change deception lawsuit can proceed in state court </h1>
   
   <p class="lede">In decision today, 8th Circuit Court of Appeals rules against defendants, upholds U.S. District Court remand of lawsuit to state court where it was originally filed</p>
   <p class="lede">Attorney General Ellisonâs lawsuit alleges ExxonMobil, American Petroleum Institute, and Koch Industries systematically deceived and defrauded Minnesotans about the true causes and costs of climate change</p>


  
 
     <p><strong>March 23, 2023 (SAINT PAUL)</strong>Â â The lawsuit that Minnesota Attorney General Keith Ellison filed on behalf of the people of Minnesota against ExxonMobil, the American Petroleum Institute, and Koch Industries for deceiving and defrauding Minnesotans about the true causes and costs of climate change can proceed in Minnesota state court where it was originally filed, theÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/docs/21-1752_Opinion.pdf" target="_blank">8thÂ Circuit Court of Appeals ruled unanimously today</a>. The court wrote in part:Â &ldquo;Minnesota is not the first state or local government to file this type of climate change litigation. Nor is this the first time that the Energy Companies â¦ have made these jurisdictional arguments. But our sister circuits rejected them in each case. â¦. Today, we join them.&rdquo;Â </p>
     
     <p>Shortly afterÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/06/24_ExxonKochAPI.asp" target="_blank">Attorney General Ellison filed the lawsuit in June 2020</a>, the defendants removed it to federal district court in Minnesota.Â <a href="https://www.ag.state.mn.us/Office/Communications/2021/03/31_ExxonKochAPI.asp" target="_blank">In March 2021, the federal district court agreed with Attorney General Ellison that the case should proceed in state court</a>Â and remanded it there. The defendants appealed to the 8thÂ Circuit Court of Appeals and today, the circuit court upheld the district court, allowing the case to proceed in state court.Â </p>
     
     <p>&ldquo;Imagine how much farther along we&rsquo;d be in the transition to a low-carbon economy if it weren&rsquo;t for the defendants&rsquo; decades of deception and disinformation.Â Our state law claims are now headed back to state court where they belong, and where every U.S. Court of Appeals has sent them,&rdquo; Attorney General Ellison said.Â </p>
     
     <p>More than two dozen states and local governments have sued actors in the fossil-fuel industry in their states&rsquo; courts for deception related to climate change. In every case, the defendants have immediately removed the cases to federal court. Every federal appeals court that has ruled on the issue has confirmed these cases belong in state courts.Â </p>
