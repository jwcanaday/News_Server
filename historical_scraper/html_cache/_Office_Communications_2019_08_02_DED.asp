...
<meta name="description" content="Attorney General Ellison moves to defend Liberians from deportation. Co-leads coalition of 15 states in amicus brief supporting suit to halt Trumpâs termination of DED.">
<meta name="keywords" content="Attorney General, Minnesota, Keith Ellison, DED, Deferred Enforced Departure, Liberia, African Communities Together v. Trump,">

<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@AGEllison" />
<meta name="twitter:title" content="Attorney General Ellison moves to defend Liberians from deportation" />
<meta name="twitter:description" content="Co-leads coalition of 15 states in amicus brief supporting suit to halt Trumpâs termination of DED " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2019/08/02_DED.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison moves to defend Liberians from deportation" />
<meta property="og:description" content="Co-leads coalition of 15 states in amicus brief supporting suit to halt Trumpâs termination of DED " />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>August 2, 2019 Press Release</title>
...
Attorney General Ellison moves to defend Liberians from deportation
	...
	<p class="lede">Co-leads coalition of 15 states in amicus brief supporting suit to halt Trumpâs termination of DED </p>
	
	
	<p><strong>August 2, 2019 (SAINT  PAUL)</strong> â Today, Minnesota Attorney  General Keith Ellison, along Massachusetts Attorney General Maura Healey co-led  a coalition of 15 attorneys general in filing an amicus brief in support of  legal action to halt the Trump Administration&rsquo;s termination of Deferred  Enforced Departure (DED) for thousands of Liberians who have been living,  working, and raising their families in the United States for decades, including  many in Minnesota. </p>
    <p>In the brief filed in <em>African  Communities Together v. Trump</em> in U.S. District Court for the District of  Massachusetts, Attorney General Ellison and the other attorneys general oppose  the federal government&rsquo;s motion to dismiss the lawsuit and argue to preserve  DED for Liberians. Deferred Enforced Departure is an immigration program  authorized by the President to protect foreign nationals whose countries have  experienced armed conflict, civil unrest, natural disasters, or public health  crises. The states contend the Trump Administration&rsquo;s attempt to terminate DED  will inflict widespread harm on Liberian families and their communities.&nbsp; </p>
    <p>&ldquo;I co-led this coalition  today to defend Liberians with DED because like all Minnesotans, they deserve  to live with safety, dignity, and respect,&rdquo; Attorney General Ellison said.  &ldquo;Liberians in Minnesota are woven into the fabric of our communities. They&rsquo;re  our neighbors, co-workers, and friends. So many work in healthcare that they&rsquo;re  our caregivers, too. Many Liberians have known no other country in their lives  than America, and their children are American citizens. I&rsquo;ll use the powers of  my office to defend all of them from the harm President Trump would do to  them,&rdquo; Ellison concluded.</p>
    <p>With this most recent amicus  brief, the attorneys general are siding again with the plaintiffs. <a href="https://www.ag.state.mn.us/Office/Communications/20190326_LiberianDEDStatus.asp">On March&nbsp;27,&nbsp;2019, Massachusetts and  Minnesota lead a multi-state group in filing an amicus brief</a> in support of the plaintiffs&rsquo; motion to enjoin the  President from ending DED protections for Liberians on March&nbsp;31. A hearing  on the motion was scheduled for the next day, March&nbsp;28. On the day of the  hearing, President Trump issued a new directive that <a href="https://twitter.com/AGEllison/status/1111329047865376770?s=20">extended DED protections for one more year</a>, until March&nbsp;31,&nbsp;2020.</p>
    <p>On July&nbsp;1,&nbsp;2019,  the Trump Administration moved to dismiss the lawsuit. Today&rsquo;s amicus brief  from the states argues against the motion to dismiss. Among other points, the  attorneys general argue that the President&rsquo;s power to extend the DED deadline  does not eliminate Plaintiffs&rsquo; harm or make the suit moot.</p>
    <p>Since the 1980s, Liberia has  experienced a series of internal armed conflicts and the largest outbreak of  the Ebola virus in history, killing and displacing thousands. Liberian  nationals were first granted DED in 1999. As DED-holders, Liberians are not  subject to immigration detention and removal and can legally reside and work in  the United States. Many have lived in the United States for decades, building  families, participating in the workforce, and contributing to their  communities. The states argue that the Trump Administration&rsquo;s attempt to  abruptly terminate DED for these long-term residents of the United States would  force them to return to dangerous conditions in Liberia. </p>
    <p>Terminating DED for Liberians  would also put at risk the welfare of thousands of children born to Liberian  parents but raised in the United States. The brief argues that these children,  who are U.S. citizens, are already suffering in fear of their parents&rsquo; removal  from the country as a result of the President&rsquo;s decision to end DED  protections. Studies show that fears about family members&rsquo; deportations can  cause children to experience serious mental health problems, including  depression and anxiety, and impair their socioemotional and cognitive  development. Forced separation from a parent is a traumatic event that could  result in these children losing not only a loving family and safe home, but  also their economic stability and wellbeing. </p>
    <p>The states also argue that  Liberians make valuable contributions to the economy. A large population of  Liberians work in the health care and social assistance industries, filling a  growing need for workers in these fields. These workers support state economies  and their removal would inflict widespread harm on the communities in which  they live and work.&nbsp;&nbsp; </p>
    <p>Attorney General Ellison and  Massachusetts Attorney General Healey were joined in filing today&rsquo;s brief by  attorneys general from California, Connecticut, Delaware, Illinois, Maryland,  Nevada, New Jersey, New York, Oregon, Rhode Island, Vermont, Washington, and  the District of Columbia.</p>
</div>
<!-- content close -->
<div id="footer">
