...
<meta name="description" content="Attorney General Ellison again supports limiting non-competes in employment">
...
<meta name="twitter:title" content="Attorney General Ellison again supports limiting non-competes in employment" />
<meta name="twitter:description" content="Joins 18 AGs in comments to FTC in favor of proposed rule he first asked for in 2019; 30M American workers bound by non-compete clauses " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2023/04/24_NonCompeteClause.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison again supports limiting non-competes in employment"/>
<meta property="og:description" content="Joins 18 AGs in comments to FTC in favor of proposed rule he first asked for in 2019; 30M American workers bound by non-compete clauses " />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>April 24, 2023 Press Release</title>
...
<div id="browseMobile" class="hide-on-desktop">
 ...
 <div id="content">
   ...
   <h1 align="center"> 
Attorney General Ellison again supports limiting non-competes in employment </h1>
   
<p class="lede">Joins 18 AGs in comments to FTC in favor of proposed rule he first asked for in 2019; 30M American workers bound by non-compete clauses</p>


  
 
     <p><strong>April 24, 2023 (SAINT PAUL)Â </strong>â Minnesota Attorney General Keith EllisonÂ has joined a coalition of 18 attorneys general in submittingÂ <a href="https://www.ag.state.mn.us/Office/Communications/2023/docs/AGs_Comment_FTC_NonCompeteRule.pdf" target="_blank">comments to the Federal Trade Commission</a>Â in support of a proposed rule that would eliminate non-compete clauses in employment contracts in most circumstances. InÂ <a href="https://www.ag.state.mn.us/Office/Communications/2019/11/18_NonCompeteClauses.asp" target="_blank">November 2019</a>, Attorney General Ellison led a coalition of attorneys general in asking the FTC to begin rule-makingÂ to classify non-compete clauses in employment contracts as an unfair method of competition and per se illegal for low-wage workers.Â </p>
     
     <p>InÂ <a href="https://www.ftc.gov/news-events/news/press-releases/2023/01/ftc-proposes-rule-ban-noncompete-clauses-which-hurt-workers-harm-competition" target="_blank">January 2023</a>, the FTC met that request by proposing theÂ <a href="https://www.ftc.gov/legal-library/browse/federal-register-notices/non-compete-clause-rulemaking" target="_blank">Non-Compete Clause Rule</a>, which would largely bar employers from preventing workers from working for or starting a competing business within a certain period after leaving a job. Approximately 30 million American workers, or about 20 percent of the national workforce, are bound by non-compete clauses.Â </p>
     
     <p>&ldquo;No one thinks it&rsquo;s fair that your employer can have free rein to block your chance to get future jobs or start your own business. It&rsquo;s another example of the economy being unfairly stacked against working folks,&rdquo; Attorney General Ellison said. &ldquo;I&rsquo;ve been fighting for years to limit the use of non-compete agreements, because doing so will make it easier for everyone to afford their lives and will unleash wealth and economic growth for every community in America. I&rsquo;m pleased the FTC has proposed this rule and look forward to it taking effect as soon as possible.&rdquo;Â </p>
     
     <p>The FTC&rsquo;s proposed rule concludes that non-competes are an unfair method of competition that can depress worker wages, reduce racial and gender equality in workplaces, and create legal hurdles for employees looking to grow their careers. Currently, the legality of such noncompete agreements is left to the states, creating confusion for workers and distorting labor markets that cover more than one state.Â </p>

     <p>Low and middle-wage workers would benefit the most from this proposed rule, with a high potential for increases in wages and job mobility. The proposed rule would also promote gender and racial equity, as studies have found that non-compete clauses cause women and non-white workers to see earnings reductions two times greater than that experienced by white male workers. In their comments, Attorney General Ellison and the coalition also note that the elimination of non-competes would benefit business and the economy as a whole, as non-competes restrict entrepreneurship and start-up activity.Â </p>
     
     <p>They also emphasize that the rule will particularly improve conditions in the healthcare industry, which is becoming increasingly concentrated in fewer employers in the United States. Non-competes are widely used in the healthcare industry and restrict entry of health care workers into their employment market, which inflates prices and decreases wages.Â </p>
     
     <p>In their comments, Attorney General Ellison and the coalition support the FTC&rsquo;s definition of &ldquo;non-compete clause,&rdquo; support the Commission&rsquo;s broad definition of &ldquo;worker,&rdquo; and urge the Commission to clarify that the proposed rule does not overtake similar laws at the state level that provide similar or greater protections to workers.Â </p>
     
     <p>In filing the comment letter,Â Attorney General Ellison<strong>Â </strong>joined the attorneys general ofÂ California, Colorado, Delaware, the District of Columbia, Illinois, Maine, Maryland, Massachusetts, Michigan, Nevada, New Jersey, New Mexico, New York, Oregon, Pennsylvania, Rhode Island, and Washington.</p>
</div><!-- content close -->
<div id="footer">
