...
<meta name="description" content="Attorney General Ellison announces new chapter in negotiations between University of Minnesota, Fairview, and Essentia">
...
<meta name="twitter:title" content="Attorney General Ellison announces new chapter in negotiations between University of Minnesota, Fairview, and Essentia" />
<meta name="twitter:description" content="Parties to take a look at all potential solutions for future of academic medicine in Minnesota with help of strategic facilitator" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2025/03/19_AcademicMedicine.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison announces new chapter in negotiations between University of Minnesota, Fairview, and Essentia" />
<meta property="og:description" content="Parties to take a look at all potential solutions for future of academic medicine in Minnesota with help of strategic facilitator" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>March 19, 2025 Press Release</title>
...
<h1>Attorney General Ellison announces new chapter in negotiations between University of Minnesota, Fairview, and Essentia</h1>
<p class="lede">Parties to take a look at all potential solutions for future of academic medicine in Minnesota with help of strategic facilitator</p>
	
 
 <p style="padding-top:2em;"><strong>March 19, 2025 (SAINT PAUL)</strong>Â â Â Minnesota Attorney General Keith Ellison today announced a new chapter in the negotiations between the University of Minnesota, Fairview, and Essentia Health regarding the future of academic medicine in Minnesota. At Attorney General Ellison&rsquo;s request, the parties have agreed to engage in renewed discussions convened by a strategic facilitator to chart a path forward for the parties. The process is designed to take a look at all potential solutions.</p>
 
 <p>&ldquo;Given the current status of the talks, the time pressure, and the importance of the public interest in getting this right, my office is taking a more active role,&rdquo;Â <strong>Attorney General Ellison said.</strong>Â &ldquo;The parties have tried to find a resolution in the past, and I commend their efforts; these are complicated matters, however. Importantly, the parties recognize the importance of these negotiations to the public interest and they welcome the chance for a fresh start. I am working with the parties to identify a strategic facilitator to aid the parties in finding a resolution and to prioritize the public interest in the parties&rsquo; negotiations.&rdquo;</p>
 
 <p>The Attorney General&rsquo;s Office will select the strategic facilitator with the parties&rsquo; input. The parties, not the State, will be financially responsible for the strategic facilitator. The strategic facilitator will be charged with facilitating the parties&rsquo; discussions and establishing communication guidelines, milestones, and deadlines. The strategic facilitator will ensure that these discussions elevate the parties&rsquo; mutual goals of promoting the public interest, including the stability and sustainability of patient care, employees, academic research and education, the medical workforce, and the overall quality of healthcare in Minnesota.Â </p>
 
 <p>The Attorney General reviews healthcare transactions underÂ <a href="https://www.revisor.mn.gov/statutes/cite/145D.01">Minn. Stat. Â§ 145D.01</a>, which authorizes the Attorney General to consider whether a healthcare transaction is in the public interest and seek court intervention if the Attorney General finds that it is not. The Attorney General also has authority over these matters as the primary regulator of Minnesota charities and to enforce the federal and state antitrust laws on behalf of the State of Minnesota and its residents. By engaging a strategic facilitator, Attorney General Ellison is not waiving this authority or preapproving the outcome of these discussions.Â </p>
