...
<meta name="description" content="Attorney General Ellison files amicus brief in support of public release of Boy Scoutsâ âPerversion Files,â with safeguards for accused. Because âsubstantial public interest in disclosure â¦ must be balanced against fairness and privacy concerns,â recommends appointment of Special Master to review each file.">
<meta name="keywords" content="Attorney General, Minnesota, Keith Ellison, Boy Scouts, ">

<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@AGEllison" />
<meta name="twitter:title" content="Attorney General Ellison files amicus brief in support of public release of Boy Scoutsâ âPerversion Files,â with safeguards for accused" />
<meta name="twitter:description" content="Because âsubstantial public interest in disclosure â¦ must be balanced against fairness and privacy concerns,â recommends appointment of Special Master to review each file" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2019/09/06_BoyScouts.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison files amicus brief in support of public release of Boy Scoutsâ âPerversion Files,â with safeguards for accused" />
<meta property="og:description" content="Because âsubstantial public interest in disclosure â¦ must be balanced against fairness and privacy concerns,â recommends appointment of Special Master to review each file" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>September 6, 2019 Press Release</title>
...
<h1>
Attorney General Ellison files amicus brief in support of public release of Boy Scoutsâ âPerversion Files,â with safeguards for accused
</h1>
	<p class="lede">Because âsubstantial public interest in disclosure â¦ must be balanced against fairness and privacy concerns,â recommends appointment of Special Master to review each file</p>
	
	
	<p><strong>September 6,&nbsp;2019&nbsp;(SAINT PAUL)</strong> â Minnesota Attorney General Keith Ellison today filed  an <em>amicus curiae</em> (&ldquo;friend of the court&rdquo;) brief in Ramsey County District  Court in support the public release of the so-called &ldquo;Perversion Files&rdquo;  maintained by the Boy Scouts of America, provided there are appropriate  safeguards for the rights of those accused. In the brief, Attorney General  Ellison argues both that there is a &ldquo;substantial public interest in disclosure  of information documenting sexual abuse within trusted youth organizations like  the Boy Scouts,&rdquo; and &ldquo;the public interest in disclosure â¦ must be balanced  against fairness and privacy concerns.&rdquo; To ensure this balance, Attorney  General Ellison recommends that the Court appoint a Special Master &ldquo;to review  each file and apply objective criteria to identify credible allegations that  are in the public interest to unseal.&rdquo;</p>
    <p>The Perversion Files, so  named by the Boy Scouts, contain the names of alleged perpetrators of sexual  abuse against Boy Scouts along with other files about the events that led to  those accusations. They are part of a broader set of files called Ineligible  Volunteer Files that the Boy Scouts have maintained for decades.</p>
    <p>&ldquo;I support releasing these  files because the public has a right to know about credible allegations about  acts of child sexual abuse,&rdquo; Attorney General Ellison said. &ldquo;When credible  allegations are disclosed, it also provides survivors with a sense of healing  and justice, and encourages more survivors to come forward, all of which are in  the public interest. At the same time, the Court can also serve the public  interest by ensuring that no baseless or unfounded accusations are released, particularly  any that may have been made simply on the basis of the accused&rsquo;s sexual  orientation or gender identity. It is a balance I am confident the Court can  strike.&rdquo;</p>
    <p>Among the criteria that  Attorney General Ellison recommends the Special Master apply in reviewing each  file for possible unsealing are: (1) the nature of the allegation; (2) the  outcome of any police investigation or prosecution; (3) the results of any  internal investigation; (4) whether the file contains admissions from an  accused offender; (5) whether the file contains other information tending to  corroborate the allegation; and (6) whether the allegation has circumstantial  guarantees of trustworthiness.&nbsp; </p>
    <p>At the same time, Attorney  General Ellison argues in the brief that &ldquo;[t]here is no public interest in  learning the identity of victims or witnesses, so such information should  remain sealed.&rdquo;</p>
    <p>In 2012, an Oregon court  released reports from the Perversion Files of alleged child sexual abuse by  more than 1,200 scout leaders. In the case of <em>John Doe 180 v. The National  Boy Scouts of America Foundation</em>, the Boy Scouts produced a separate list  of 1,500 scout leaders accused of misconduct against children and the  corresponding Perversion Files, but the list and files were sealed by court  order when the case was settled in 2014. Plaintiff John Doe&nbsp;180 is now  seeking permission from the Court to unseal the files and release them to the  public.</p>
    <p>A copy of the brief is <a href="https://www.ag.state.mn.us/Office/Cases/BoyScouts_AmicusMemo.pdf">available  on the website of Minnesota Attorney General Ellison</a>.</p>
</div>
<!-- content close -->
<div id="footer">
