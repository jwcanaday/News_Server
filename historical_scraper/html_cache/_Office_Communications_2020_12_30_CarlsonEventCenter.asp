...
<meta name="description" content="Attorney Generalâs office files new enforcement action against event center set on hosting New Yearâs Eve party ">
...
<meta name="twitter:title" content="Attorney Generalâs office files new enforcement action against event center set on hosting New Yearâs Eve party" />
<meta name="twitter:description" content="Carlson Event Center in Winnebago threatens to put community at risk by violating ban on indoor events and entertainment intended to slow the spread of COVID-19" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2020/12/30_CarlsonEventCenter.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney Generalâs office files new enforcement action against event center set on hosting New Yearâs Eve party" />
<meta property="og:description" content="Carlson Event Center in Winnebago threatens to put community at risk by violating ban on indoor events and entertainment intended to slow the spread of COVID-19" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>December 30, 2020 Press Release</title>
...
<h1>Attorney Generalâs office files new enforcement action against event center set on hosting New Yearâs Eve party </h1>
<p class="lede">Carlson Event Center in Winnebago threatens to put community at risk by violating ban on indoor events and entertainment intended to slow the spread of COVID-19 </p>



	<p><strong>December 30, 2020 (SAINT PAUL)</strong> â Minnesota Attorney General Keith Ellison announced today that his office has filed a <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/CarlsonEventCenter_Complaint.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">lawsuit against Carlson Event Center in Winnebago, which has advertised that it will hold a &ldquo;New Years Eve Bash&rdquo;</a> on December 31, 2020 into the early morning hours of January 1, 2021, in violation of Governor Tim Walz&rsquo;s <a href="https://mn.gov/governor/assets/EO%2020-99%20Final%20%28003%29_tcm1055-454294.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">Executive Order 20-99</a>, as that order has been extended and modified by <a href="https://mn.gov/governor/assets/EO%2020-103%20Final%20Signed%20and%20Filed_tcm1055-458627.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">Executive Order 20-103</a>.  Among the requirements of those orders â targeted dial-backs of certain activities to halt the spread of COVID-19 â are that venues hosting indoor events and entertainment, like concert halls and performance venues, must temporarily close to the public until January 10, 2021 at 11:59 p.m. </p>
	
	<p>Carlson Event Center&rsquo;s advertisement indicates that it will be hosting a &ldquo;big new year&rsquo;s dance,&rdquo; urging attendees to bring their own beer and liquor. The Attorney General&rsquo;s Office attempted to reach out to the business, but calls and emails went unreturned. </p>
	
	<p>&ldquo;Performance venues, like many other businesses, have been hurting during this pandemic. I&rsquo;m glad to see efforts like the recently-passed Minnesota aid package and the Minnesota-born national Save Our Stages Act are out there helping these businesses make it through this challenging time. By far the vast majority of indoor venues have been complying with the law all along. But when a business irresponsibly opens to the public to throw a dance party, their insistence on violating the law is simply prolonging the pain of the pandemic for everyone,&rdquo; Attorney General Ellison said. </p>
	
	
	<p>&ldquo;I don&rsquo;t enjoy using the enforcement tools I have available because I&rsquo;d much prefer all establishments do the right thing on their own, but I will continue to use them when I have no other choice to protect Minnesotans from this deadly virus,&rdquo; Attorney General Ellison concluded. </p>
	
	<p>In its lawsuits against the event center, Attorney General Ellison&rsquo;s office has asked the court to: </p>
	
	<ul>
	  <li>Declare that defendants&rsquo; actions constitute violations of Executive Order 20-99, as extended and modified by Executive Order 20-103;  </li>
	  <li>Stop anyone associated with these establishments from violating or threatening to violate the executive orders;  </li>
	  <li>Award restitution, disgorgement, or damages to the State; </li>
	  <li>Impose civil penalties of up to $25,000 for each violation or threatened violation of the executive order; </li>
	  <li>Award the State its costs; and </li>
	  <li>Impose any other relief the court finds just. </li>
    </ul>
	
	<p>Any and all fines the court may impose go to the State of Minnesota general fund, not the Attorney General&rsquo;s Office. </p>
	
	<p>Attorney General Ellison&rsquo;s office is continuing to work closely with state agencies and local law enforcement to gather evidence of violations of the executive order and will actively pursue more enforcement actions where violations have taken place. The Attorney General&rsquo;s office and its partners have a range of <a href="https://www.ag.state.mn.us/Office/Communications/2020/12/16_ExecutiveOrderEnforcement.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">enforcement tools</a> at their disposal to hold businesses, their owners, and agents accountable for violating the order. </p>
	
	<p>Attorney General Ellison&rsquo;s office has civil authority to enforce the terms of Executive Order 20-99 as extended by Executive Order 20-103 and seek relief if necessary. The Governor&rsquo;s <a href="https://www.revisor.mn.gov/statutes/cite/12.32" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">executive orders have the force and effect of law</a> during the peacetime emergency. </p>
	
	
	<hr>
	<h2>Update</h2>
		<p><strong>December 31, 2020 â 3:55 PM <br><a href="31_CarlsonEventCenter.asp"  class="font115">Court orders Winnebago Event Center not to hold âNew Years Eve Bash,â comply with executive orders</a> </strong> <br>
Attorney Generalâs office wins temporary restraining order against Carlson Event Center; establishment must now comply with order or risk being found in contempt of court</p>
