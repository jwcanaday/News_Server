...
<meta name="description" content="Attorney General Ellison files lawsuit against âpublic chargeâ rule. New rule âbait-and-switchâ means families and children will have less access to food, healthcare, and shelter, meaning more burden for all communities.">
<meta name="keywords" content="Attorney General, Minnesota, Keith Ellison, Hospice, Charity, Donation,">

<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@AGEllison" />
<meta name="twitter:title" content="Attorney General Ellison files lawsuit against âpublic chargeâ rule" />
<meta name="twitter:description" content="New rule âbait-and-switchâ means families and children will have less access to food, healthcare, and shelter, meaning more burden for all communities" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2019/08/15_PublicChargeRule.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison files lawsuit against âpublic chargeâ rule" />
<meta property="og:description" content="New rule âbait-and-switchâ means families and children will have less access to food, healthcare, and shelter, meaning more burden for all communities" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>August 15, 2019 Press Release</title>
...
<h1>
Attorney General Ellison files lawsuit against âpublic chargeâ rule
</h1>
	<p class="lede">New rule âbait-and-switchâ means families and children will have less access to food, healthcare, and shelter, meaning more burden for all communities
</p>
	
	
	<p><strong>August&nbsp;15,&nbsp;2019&nbsp;(SAINT  PAUL)</strong> â Minnesota Attorney General Keith Ellison and 12 other attorneys general filed  a lawsuit late yesterday against the U.S. Department of Homeland Security over  changes to the &ldquo;public charge&rdquo; rule that target lawfully-present immigrants and  their families. Under the changes, if an immigrant who is legally in the  country uses benefits to which he or she is legally entitled â such as food  assistance, healthcare, or&nbsp; housing assistance â even for a short time,  the federal government may deny their legal status or prevent family  reunification. </p>
    <p>Federal  law and practice for decades has allowed lawfully-present immigrants to apply  for limited public benefits if they have been in the country for at least five  years. The new rule creates a &ldquo;bait-and-switch&rdquo; â if immigrants use the public  assistance to which they are and will remain legally entitled, they could  jeopardize their chances of renewing their legal status, or becoming permanent  residents, or reunifying close family members.</p>
    <p>Even  if an individual does not currently use these benefits, the new rule radically  expands the government&rsquo;s ability to deny status renewal or permanent residency  to anyone they predict will use a broad range of short-term benefits â without  any clear or reviewable formula for making that determination.</p>
    <p>&ldquo;Minnesotans  want everyone to live with the same dignity and respect that they want for  themselves,&rdquo; Attorney General Ellison said. &ldquo;We&rsquo;re a welcoming people because  we know we&rsquo;re stronger together and see immigrants contributing to our  communities every day. But once again, the President is trying to divide  Minnesotans from each other, this time by pulling a bait-and-switch on our  immigrant neighbors, friends, and co-workers. But it won&rsquo;t hurt just them â it  will be a burden on and hurt every one of us in the long run. I&rsquo;m using the  tools of my office to fight for all Minnesotans and our best future together.&rdquo;</p>
    <h2>Lawsuit  allegations</h2>
    <p>In  the lawsuit filed late yesterday, Attorney General Ellison joined a coalition  of 13 total states, led by Washington State Attorney General Bob Ferguson and  Virginia Attorney General Mark Herring, in asserting that the Department of  Homeland Security (DHS) violated federal immigration statutes, the Welfare  Reform Act and the Administrative Procedure Act when it unlawfully and  radically expanded the definition of &ldquo;public charge.&rdquo; </p>
    <p>The  attorneys general assert that the rule violates the Immigration and  Naturalization Act by redefining &ldquo;public charge&rdquo; in a way unconnected to its  original meaning and Congress&rsquo; intent.</p>
    <p>The  lawsuit asserts that the &ldquo;bait-and-switch&rdquo; that the rule creates for immigrants  who use benefits for which they are legally entitled contradicts Congress&rsquo;  intent and violates the Welfare Reform Act.</p>
    <p>The  attorneys general also assert that DHS violated the Administrative Procedure  Act in numerous ways, including by reversing a decades-old, consistent policy  without reasoned analysis and offering an explanation for the rule that runs  counter to the overwhelming evidence before the agency.&nbsp; </p>
    <h2>Radical  redirection of federal immigration law</h2>
    <p>In  the lawsuit, Attorney General Ellison and the other attorneys general argue  that the Trump Administration's rule &quot;effects a radical redirection of  federal immigration law from a system that promotes economic mobility among  immigrants to one that advantages immigrants with wealth.&quot;</p>
    <p>Under  long-standing law and policies, the public charge rule has focused on an  individual whose survival depends upon a specific public benefit â cash  assistance â or who is institutionalized for long-term care at government  expense. This does not include temporary assistance, such as food or housing  assistance or healthcare. Under this long-standing policy and practice,  immigration officers can deny new visas, visa renewals and lawful permanent  residency under the public charge rule only if the applicant meets this  concrete definition. If an individual already present in the United States becomes  a public charge, they can be deported. </p>
    <p>Under  the new rule, a public charge now will include lawfully present individuals or  families who&nbsp; use a broad range of federal assistance for housing, food or  healthcare at any time in the future, for as short as four months. </p>
    <p>The  new definition expands immigration officials&rsquo; ability to deny visas and  permanent residency to any individual who they predict may use these types of  assistance in the future. This includes restrictive scrutiny on persons from  large families, who do not earn 250&nbsp;percent of the federal poverty rate,  who are not fluent in English, who are under 18 or over 65, and who have  medical conditions.</p>
    <h2>Rule&rsquo;s  impacts on families, burden on public health and healthcare system</h2>
    <p>The  Department of Homeland Security concedes in the rule that it would &ldquo;deter  legally present visa holders from using important assistance programs.&rdquo; Some of  these impacts, which will burden public health and the healthcare system,  include:</p>
    <ul class="LIDisc">
      <li>Many  visa holders and applicants for permanent residency will refrain from seeking  assistance or healthcare for themselves or their families out of fear that it  could make them ineligible to renew their legal immigration status, become a  permanent resident, or apply for a close family member abroad. </li>
      <li>This  chilling effect will cause fewer families and children to receive services they  need, including food, healthcare, and housing. Many children will go without  adequate meals, vaccines, or shelter, and more families will suffer  homelessness. This will have impact overall public health and well-being for  both lawfully-present immigrants and U.S.-born citizens.</li>
      <li>Hundreds  of thousands of people will lose healthcare for themselves and their families.  Many of these people will go to the emergency room for routine medical care,  requiring states to cover the vastly more expensive medical costs.</li>
      <li>Women  will lose routine reproductive-care services, resulting in more high-risk  deliveries and increased costs for newborns whose health is compromised by the lack  of adequate pre-natal care. </li>
    </ul>
   
    <p>Joining  Attorney General Ellison in today&rsquo;s multistate lawsuit are the attorneys  general of Colorado, Delaware, Illinois, Maryland, Massachusetts, Michigan,  Minnesota, Nevada, New Jersey, New Mexico, Rhode Island, Virginia, and Washington. A copy of the lawsuit is available on the  website of Washington Attorney General Bob Ferguson.</p>
