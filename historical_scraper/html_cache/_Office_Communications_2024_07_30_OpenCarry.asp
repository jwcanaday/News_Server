...
<meta name="description" content="Attorney General Ellison asks full Eighth Circuit to review decision allowing 18-year-olds to obtain open-carry gun permits">
...
<meta name="twitter:title" content="Attorney General Ellison asks full Eighth Circuit to review decision allowing 18-year-olds to obtain open-carry gun permits" />
<meta name="twitter:description" content="Petitions 8th Circuit Court of Appeals for review by full court of three-judge panel decision ruling that 18- to 20-year-olds may obtain permits to open carry pistols in Minnesota, contrary to longstanding Minnesota law and historical tradition" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2024/07/30_OpenCarry.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison asks full Eighth Circuit to review decision allowing 18-year-olds to obtain open-carry gun permits" />
<meta property="og:description" content="Petitions 8th Circuit Court of Appeals for review by full court of three-judge panel decision ruling that 18- to 20-year-olds may obtain permits to open carry pistols in Minnesota, contrary to longstanding Minnesota law and historical tradition" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>July 30, 2024 Press Release</title>
...
<h1>Attorney General Ellison asks full Eighth Circuit to review decision allowing 18-year-olds to obtain open-carry gun permits</h1>

<p class="lede">Petitions 8th Circuit Court of Appeals for review by full court of three-judge panel decision ruling that 18- to 20-year-olds may obtain permits to open carry pistols in Minnesota, contrary to longstanding Minnesota law and historical tradition</p>
<p class="lede">Argues panel decision failed to consider Supreme Court guidance in recent opinion that upheld a federal law criminalizing firearms possession by domestic abusers</p>


 <p style="margin-top:2em;"><strong>July 30, 2024 (SAINT PAUL)Â </strong>â Minnesota Attorney General Keith Ellison todayÂ <a href="https://www.ag.state.mn.us/Office/Communications/2024/docs/23-2248_Rehearing_Petition.pdf">filed a petition for rehearing with the 8th Circuit Court of Appeals</a>, asking the full court to review a July 16, 2024 decision of a three-judge panel of the court that struck down Minnesota&rsquo;s ban on issuing public carry permits to those younger than 21 as unconstitutional. In the petition asking forÂ <em>en banc</em>Â review â meaning review by all the judges of the 8th Circuit, rather than the three-judge panel that issued this month&rsquo;s decision â Attorney General Ellison argues that the panel failed to consider the impact of the U.S. Supreme Court&rsquo;s June 21, 2024 decision inÂ <em>United States vs. Rahimi</em>, which upheld the constitutionality of a federal law criminalizing firearms possession by domestic abusers.Â <em>Rahimi</em>Â clarified the proper method of analysis for Second Amendment challenges. The panel issued its decision without allowing the parties to further brief the court on the impact ofÂ <em>Rahimi</em>Â on the current case, known asÂ <em>Worth</em>.</p>
 
 <p>Minnesota&rsquo;s statute restricting permits to carry a pistol in public to people 21 years of age and older is more than 20 years old. Thirty states and the District of Columbia have similar laws. The 8th Circuit is the first federal appeals circuit in the country to invalidate a state law limiting permits to carry to people 21 and above.</p>
 
 <p>&ldquo;I believe the court erred earlier this month in ruling that the Second Amendment requires Minnesota to allow open carry by youth as young as 18,&rdquo;Â <strong>Attorney General Ellison said.</strong>Â &ldquo;Respectfully, I believe the court reached the wrong conclusion on the facts and the history, especially in light of the Supreme Court&rsquo;s recent, common-sense decision to uphold a federal law criminalizing gun possession by domestic abusers and the guidance the court offered in that decision for evaluating challenges like these.</p>
 
 <p>&ldquo;The public safety benefits to banning open carry by people under 21 years of age are clear. As long as I am your Attorney General, Minnesota will defend lifesaving, common-sense, gun-safety laws. Today, I am taking the next logical step in attempting to reverse the panel&rsquo;s decision by asking the full 8th Circuit to review it,&rdquo;Â <strong>Attorney General Ellison concluded.</strong></p>
 
 <h2>History of Worth case</h2>
 
 <p>On June 7, 2021, two national Second Amendment-advocacy groups, one Minnesota-based advocacy group, and three individuals sued the Minnesota Department of Public Safety and three County Sheriffs in U.S. District Court for the District of Minnesota. The plaintiffs sought to enjoin Minnesota&rsquo;s permit-to-carry statute, claiming it violated the Second Amendment rights of 18- to 20-year-olds because permit applicants must be at least 21 years old before they can obtain a permit to carry a gun in public. After discovery, all parties moved for summary judgment.</p>
 
 <p>On March 31, 2023, U.S. District Court Judge Katherine M. Menendez granted plaintiffs&rsquo; summary judgment in part. The district court held that Minnesota&rsquo;s statute violated the Second Amendment rights of 18- to 20-year-olds. The District Court initially blocked enforcement of the law against otherwise qualified Minnesotans ages 18 to 20. But on April 23, 2023, the district court stayed the injunction &ldquo;for the duration of the appellate process.&rdquo;</p>
 
 <p>On May 17, 2023, the State appealed to the Eighth Circuit Court of Appeals. While the appeal was pending, the individual plaintiffsâincluding plaintiff Kristin Worth â all reached the age of 21. The organizational plaintiffs sought to supplement the record with a sworn statement from a new plaintiff under the age of 21. The State moved to dismiss the appeal, arguing the case was moot.</p>
 
 <p>On July 16, 2024, a three-judge panel of the Eighth Circuit affirmed the District Court&rsquo;s injunction, allowed plaintiffs to supplement the record, and denied the State&rsquo;s motion to dismiss. The panel held that the State did not proffer sufficient evidence of historical laws restricting people under 21 from carrying handguns in public to rebut the presumption that such conduct is protected under the Second Amendment.Â  As a result, the panel concluded that the age restriction in Minnesota&rsquo;s permit-to-carry statute was unconstitutional.</p>
