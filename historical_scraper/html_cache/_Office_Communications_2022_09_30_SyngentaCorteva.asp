...
<meta name="description" content="Attorney General Ellison sues pesticides manufacturers for increasing costs for farmers">
...
<meta name="twitter:title" content="Attorney General Ellison sues pesticides manufacturers for increasing costs for farmers" />
<meta name="twitter:description" content="Files federal lawsuit with FTC and bipartisan coalition of 10 AGs against Syngenta and Corteva for anticompetitive âloyalty programsâ that reduce competition, increase prices" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2022/09/30_SyngentaCorteva.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison sues pesticides manufacturers for increasing costs for farmers"/>
<meta property="og:description" content="Files federal lawsuit with FTC and bipartisan coalition of 10 AGs against Syngenta and Corteva for anticompetitive âloyalty programsâ that reduce competition, increase prices" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>September 30, 2022 Press Release</title>
...
<h1>Attorney General Ellison sues pesticides manufacturers for increasing costs for farmers</h1>


<p class="lede">Files federal lawsuit with FTC and bipartisan coalition of 10 AGs against Syngenta and Corteva for anticompetitive âloyalty programsâ that reduce competition, increase prices
</p>
...
<p><strong>September 30, 2022 (SAINT PAUL)</strong>Â âÂ Minnesota Attorney General<strong>Â </strong>Keith Ellison<strong>Â </strong>has <strong></strong>joined theÂ <a href="https://www.ftc.gov/news-events/news/press-releases/2022/09/ftc-state-partners-sue-pesticide-giants-syngenta-corteva-using-illegal-pay-block-scheme-inflate" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-safelink="true" data-linkindex="0">Federal Trade Commission</a>Â and a bipartisan coalition of 10 attorneys general in filing aÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/docs/SyngentaCorteva_Complaint.pdf" target="_blank">federal lawsuit against pesticide makers Syngenta and Corteva</a>, alleging anti-competitive practices that have harmed farmers.Â Â </p>

<p>TheÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/docs/SyngentaCorteva_Complaint.pdf" target="_blank">complaint</a>, filed in U.S. District Court in the Middle District of North Carolina, accuses the defendants of using &ldquo;loyalty programs&rdquo; with pesticide distributors to exclude generic competitors from the market. The programs reward distributors for selling Syngenta and Corteva products long after their patent and other protections have expired, thus stifling competition and inflating prices. &ldquo;These unlawful business practices have cost farmers many millions of dollars a year,&rdquo; the complaint alleges.Â Â </p>

<p>&ldquo;It&rsquo;s my job to protect Minnesotans&rsquo; wallets and pocketbooks from unfair and illegal practices. One of the main reasons Minnesotans&rsquo; cost of living is so high is corporate profiteering, and one way corporations keep profits high at consumers&rsquo; expense is by creating unfair markets where there&rsquo;s no meaningful competition,&rdquo; Attorney General Ellison said. &ldquo;This is especially true in agriculture, where farms and farming communities face artificially high prices and struggle to afford their lives because anticompetitive behavior by Big Ag corporations deliberately leaves them with few choices.Â </p>

<p>&ldquo;That&rsquo;s happening here. By creating anticompetitive so-called &lsquo;loyalty programs,&rsquo; these corporations have artificially inflated expenses for Minnesota farmers â while lining their own pockets with more profit. Higher costs for our farmers and their families don&rsquo;t just hurt them: they hurt Greater Minnesota communities and every Minnesotan, who are hit with higher prices for food while corporate CEOs get richer,&rdquo; Attorney General Ellison concluded.Â </p>

<p>The lawsuit accuses Syngenta and Corteva of violating state and federal laws, including the FTC Act and the Clayton Act. The FTC and state attorneys general ask the court to end the loyalty programs, and grant equitable monetary relief and attorney fees, among other remedies. The relief would include restitution for farmers in Minnesota based on Syngenta&rsquo;s and Corteva&rsquo;s ill-gotten profits.Â Â </p>

<p>Syngenta â based in Basel, Switzerland, and a subsidiary of Sinochem Holdings Corp. of China â and Corteva, based in Indianapolis, are among the largest makers of crop-protection products in the United States. The companies' products are used on a wide range of grains, vegetables, fruits, and other crops, helping improve yields and food security.Â Â </p>

<p>To encourage innovation, companies such as Syngenta and Corteva can initially develop, patent, and register active ingredients in their products and exploit their commercial potential for several years. After those protections expire, generic manufacturers may enter the market with products with the same active ingredients and relying on the same toxicology and environmental impact studies. This competition ordinarily leads to dramatic price reductions, benefiting farmers and consumers.Â Â </p>

<p>The complaint accuses Syngenta and Corteva of undermining this system by paying incentive payments, or &ldquo;rebates,&rdquo; to distributors on one condition: The distributor must keep its purchases of comparable generic products below a low threshold. Corteva and Syngenta have entered into loyalty-program agreements with substantially all leading distributors in the United States. In turn, the distributors sell the products containing the branded ingredients to retail outlets.Â Â </p>

<p>These loyalty programs enable the defendants to maintain high prices and dominant market positions years after exclusivity for an active ingredient has expired. They also have forced generic manufacturers out of the market, the lawsuit alleges.Â Â </p>

<p>Joining Attorney General Ellison and the FTC in the lawsuit are the bipartisan attorneys general ofÂ California, Colorado, Illinois, Indiana, Iowa, Nebraska, Oregon, Texas, and Wisconsin.Â </p>
