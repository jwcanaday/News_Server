...
<meta name="description" content="Attorney General Ellison applauds $15M grant to increase competition for meat and poultry processors, pledges vigilant antitrust enforcement">
...
<meta name="twitter:title" content="Attorney General Ellison applauds $15M grant to increase competition for meat and poultry processors, pledges vigilant antitrust enforcement" />
<meta name="twitter:description" content="Part of first round of USDA grants and investments designed to increase competition, increase small and mid-size producer income, create economic opportunity, and lower consumersâ costs" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2022/11/04_USDA_Grant.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison applauds $15M grant to increase competition for meat and poultry processors, pledges vigilant antitrust enforcement"/>
<meta property="og:description" content="Part of first round of USDA grants and investments designed to increase competition, increase small and mid-size producer income, create economic opportunity, and lower consumersâ costs" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>November 4, 2022 Press Release</title>
...
<h1>Attorney General Ellison applauds $15M grant to increase competition for meat and poultry processors, pledges vigilant antitrust enforcement</h1>


<p class="lede">Part of first round of USDA grants and investments designed to increase competition, increase small and mid-size producer income, create economic opportunity, and lower consumersâ costs
</p>
...
<p align="left"><strong>November 4, 2022 (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison, who has focusedÂ his office&rsquo;s anti-trust workÂ on fairness in Minnesota&rsquo;s agriculturalÂ marketsÂ andÂ rural communities, today applaudedÂ the news that the U.S. Department of Agriculture (USDA) hasÂ <a href="https://www.mda.state.mn.us/minnesota-receives-15-million-boost-meat-poultry-processing" target="_blank">granted the Minnesota Department of Agriculture (MDA) Rural Finance Authority $15 million to establish a new Meat and Poultry Revolving Loan Fund</a>Â that will increase competition and economic opportunities for meat and poultry processors in Minnesota. The grant to Minnesota is part ofÂ <a href="https://www.usda.gov/media/press-releases/2022/11/02/biden-harris-administration-announces-first-round-historic" target="_blank">USDA&rsquo;s first round of Meat and Poultry Processing Expansion Program (MPPEP) grant projects</a>Â that are designedÂ to increase competition, expand meat and poultry processing capacity, increase incomes for small and mid-size producers, create jobs and economic opportunities in rural areas, strengthen the food supply chain, and lower food costs for consumers and working families.Â Â </p>

<p align="left">As these resources arrive in Minnesota, Attorney General Ellison will continue to use his office&rsquo;s powers to enforce market fairness in agriculture and will continue to monitor for predatory pricing and other unfair and anticompetitive business practices.Â </p>

<p align="left">&ldquo;Fair agricultural markets benefit everyone: farmers and their families, Greater Minnesota communities, and all Minnesota consumers. Minnesota&rsquo;s hard-working small and mid-size beef and poultry producers and their families want to be able to trust that they can get fair-market value for their products. Minnesota consumers want to have the confidence that they&rsquo;re paying a fair price for meat and poultry products. But these markets aren&rsquo;t working for producers or consumers right now â markets are already extremely consolidated, and supply-chain disruptions are making it even harder for producers and their families to make a living, and harder for consumers to afford food.Â </p>

<p align="left">&ldquo;Fortunately, this USDA grant to MDA will create opportunities for Minnesota&rsquo;s small and mid-size rural businesses to grow and compete more effectively, which will help everyone. With my office&rsquo;s enforcement authority over antitrust behavior, we will remain vigilant for market manipulation as these small businesses work to expand.&rdquo;Â </p>

<p align="left">Attorney General Ellison is a consistent, strong advocate for increasing competition in agriculture to benefit both small and mid-size producers as well as consumers.Â <a href="https://www.ag.state.mn.us/Office/Communications/2022/docs/Ltr_PackersAndStockyards.pdf" target="_blank">In December 2021, Attorney General Ellison co-led a bipartisan group of 16 attorneys general in advocating for increasing competition in the meat-processing industry</a>Â in a letter to USDA Secretary Tom Vilsack. In response, in January 2022 the U.S. Department of Justice and USDA jointly announced theirÂ <a href="https://www.justice.gov/opa/pr/justice-department-and-agriculture-department-issue-shared-principles-and-commitments-protect" target="_blank">shared commitment to effectively enforcing federal competition laws</a>Â that protect farmers, ranchers, and other agricultural producers and growers from unfair and anticompetitive practices, including the antitrust laws and the Packers and Stockyards Act. Â </p>

<p align="left">In response to the same advocacy by the bipartisan coalition of attorneys general that Attorney General Ellison led, in September 2022 USDA announced a newÂ <a href="https://www.usda.gov/media/press-releases/2022/09/26/biden-harris-administration-announces-major-actions-spur" target="_blank">$15 million Agricultural Competition collaboration with the State Attorneys General</a>Â on enforcement of the competition laws strengthening the USDA&rsquo;s partnerships with state attorneys general. Â </p>

<p align="left">Attorney General Ellison welcomedÂ <a href="https://www.ag.state.mn.us/Office/Communications/2022/01/03_MeatProcessingIndustry.asp" target="_blank">both</a>Â <a href="https://www.ag.state.mn.us/Office/Communications/2022/09/28_USDA.asp" target="_blank">developments</a>.</p>
