...
<meta name="description" content="Attorney General Ellison announces $60M multistate settlement with C.R. Bard   ">
...
<meta name="twitter:title" content="Attorney General Ellison announces $60M multistate settlement with C.R. Bard " />
<meta name="twitter:description" content="Minnesota joins group of 48 states in holding C.R. Bard accountable for misrepresenting the risks of its surgical mesh products; C.R. Bard to pay Minnesota over $1 million  " />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2020/09/25_CRBard.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison announces $60M multistate settlement with C.R. Bard " />
<meta property="og:description" content="Minnesota joins group of 48 states in holding C.R. Bard accountable for misrepresenting the risks of its surgical mesh products; C.R. Bard to pay Minnesota over $1 million  " />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>September 25, 2020 Press Release</title>
...
<h1>Attorney General Ellison announces $60M multistate settlement with C.R. Bard   
</h1>
	<p class="lede">Minnesota joins group of 48 states in holding C.R. Bard accountable for misrepresenting the risks of its surgical mesh products; C.R. Bard to pay Minnesota over $1 million  </p>

	<p><strong>September 25, 2020 (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison today announced a $60 million multistate settlement with C.R. Bard, Inc. and its parent company Becton, Dickinson and Company over allegations that C.R. Bard deceptively marketed its transvaginal surgical mesh devices, which harmed consumers nationwide.Â Â Â </p>
	
	<p>TheÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/CRBard_ConsentJudgment.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">settlement</a>, reached between C.R. Bard and the attorneys general of 48 states and the District of Columbia, concludes a multistate investigation into C.R. Bard&rsquo;s alleged misrepresentations and failure to adequately disclose serious and life-altering risks of surgical mesh devices, such as chronic pain, scarring and shrinking of bodily tissue, painful sexual relations, and recurring infections, among other complications.Â Â Â </p>
	
	<p>Surgical mesh is a synthetic knitted or woven fabric that is permanently implanted in the pelvic floor through the vagina to treat pelvic organ prolapse and stress urinary incontinence. These are common conditions faced by women due to a weakening in their pelvic floor muscles caused by childbirth, age, and other factors.Â Â Â </p>
	...
	<p>&ldquo;All Minnesotans should be able to trust that the medical procedures they undergo are safe and reliable. That is basic to affording your life and living with dignity, safety, and respect. But C.R. Bard falsely touted the safety of its surgical mesh products despite the severe risks these products presented,&rdquo; Attorney General Ellison said. &ldquo;By reforming C.R. Bard&rsquo;s practices and holding the company accountable for its misconduct, this settlement is a win for Minnesotans.&rdquo;Â </p>
	
	<p>C.R. Bard and its parent company, Becton, Dickinson and Company, have agreed to pay $60 million to the 48 participating states and the District of Columbia. Minnesota&rsquo;s share of the settlement is approximately $1,016,000.Â Â Although C.R. Bard stopped selling transvaginal mesh, the settlement provides injunctive relief, requiring both C.R. Bard and Becton, Dickinson and Company to adhere to certain injunctive terms if they reenter the transvaginal mesh market. Â </p>
	
	<p>Under the terms of theÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/docs/CRBard_ConsentJudgment.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">consent judgment</a>, which will be filed with the Ramsey County District Court, the companies have agreed to strong injunctive relief if they reenter the market, including:Â </p>
	
	<ul>
	  <li>Provide patients with understandable descriptions of complications in marketing materials.Â </li>
	  <li>Include a list of certain complications in all marketing materials that address complications.Â </li>
	  <li>Disclose complications related to the use of mesh in any training provided that includes risk information. Â </li>
	  <li>Disclose sponsorship in clinical studies, clinical data, or preclinical data for publication.Â </li>
	  <li>Refrain from citing to any clinical study, clinical data, or preclinical data regarding mesh, for which the company has not complied with the disclosure requirements.Â </li>
	  <li>Require consultants to agree to disclose in any public presentation or submission for publication Bard&rsquo;s sponsorship of the contracted for activity.Â </li>
	  <li>Register all Bard-sponsored clinical studies regarding mesh with ClinicalTrials.gov.Â </li>
	  <li>Train independent contractors, agents, and employees who sell, market, or promote mesh, regarding their obligations to report all patient complaints and adverse events to the company.Â </li>
	  <li>Ensure that its practices regarding the reporting of patient complaints are consistent with FDA requirements.Â </li>
    </ul>
	
	<p>Attorney General Ellison encourages consumers who have been implanted with a transvaginal surgical mesh device and have questions about this settlement to contact the Minnesota Attorney General&rsquo;s Office by calling (651) 296-3353 (Metro area) or (800) 657-3787 (Greater Minnesota), or by submitting theÂ <a href="https://www.ag.state.mn.us/Office/Complaint.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">complaint form</a>Â on the Attorney General&rsquo;s website.Â Â Â </p>
