...
<meta name="description" content="Attorney General Ellison: âClimate damage and deception lawsuit filed in state court belongs in state courtâ">
...
<meta name="twitter:title" content="Attorney General Ellison: âClimate damage and deception lawsuit filed in state court belongs in state courtâ" />
<meta name="twitter:description" content="Hails federal court decision to send lawsuit against ExxonMobil and others back to state court; court calls Stateâs suit a âwell-pleaded consumer protection actionâ and defendantsâ attacks âa caricatureâ" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2021/03/31_ExxonKochAPI.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison: âClimate damage and deception lawsuit filed in state court belongs in state courtâ"/>
<meta property="og:description" content="Hails federal court decision to send lawsuit against ExxonMobil and others back to state court; court calls Stateâs suit a âwell-pleaded consumer protection actionâ and defendantsâ attacks âa caricatureâ" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>March 31, 2021 Press Release</title>
...
<h1>Attorney General Ellison: âClimate damage and deception lawsuit filed in state court belongs in state courtâ</h1>


<p class="lede">Hails federal court decision to send lawsuit against ExxonMobil and others back to state court; court calls Stateâs suit a âwell-pleaded consumer protection actionâ and defendantsâ attacks âa caricatureâ</p>


	<p align="left"><strong>March 31, 2021 (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison today hailed theÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/docs/Exxon_OrderGrantingRemandAndDenyingStay.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="0">decision of U.S. District Court Judge John R. Tunheim</a>Â to remand to state court theÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/06/24_ExxonKochAPI.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="1">State&rsquo;s lawsuit to hold ExxonMobil, Koch Industries, and the American Petroleum Institute accountable</a>Â under state laws for their decades of deception about climate change and the resulting costs and consequences in Minnesota.Â </p>
	
	<p align="left">&ldquo;We appreciate Judge Tunheim&rsquo;s clear and thorough analysis in today&rsquo;s ruling, including both his order to remand our case back to state court where it was originally filed, and to deny the defendants&rsquo; motion to stay our case pending proceedings in other federal courts.Â Â This is the 11th federal court to come to the same conclusionâthat climate damage and deception lawsuits filed in state court belong in state court.Â Â We are eager to prepare for trial in state court to pursue our claims on behalf of all Minnesotans,&rdquo; Attorney General Ellison said.Â </p>
	
	<p align="left">In hisÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/docs/Exxon_OrderGrantingRemandAndDenyingStay.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="2">decision</a>, Judge Tunheim observed that the defendants&rsquo; attacks on the State&rsquo;s case amount to &ldquo;a caricature&rdquo; and that they &ldquo;overstate both the State&rsquo;s claims and what is required to prove them under Minnesota law.&rdquo; He also wrote that the &ldquo;Court declines Defendants&rsquo; invitation to interpret this well-pleaded consumer protection action as a wholesale attack on all features of global fossil fuel extraction, production, and policy.&rdquo;Â Â Â </p>
	
	<p align="left"><a href="https://www.ag.state.mn.us/Office/Communications/2020/06/24_ExxonKochAPI.asp" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="3">Attorney General Ellison initially filed the State&rsquo;s complaint against ExxonMobil, Koch Industries, and the American Petroleum Institute in Ramsey County on JuneÂ 24,Â 2020</a>. The complaint alleged violations of the State&rsquo;s Consumer Fraud Act, Deceptive Trade Practices Act, False Statements in Advertising Act, as well as fraud and misrepresentation, and a failure to warn, under Minnesota common law.Â Â Defendants subsequently removed the case to the U.S. District Court for the District of Minnesota, where oral arguments were held on JanuaryÂ 19,Â 2021.Â </p>
	<p>&nbsp;</p>
