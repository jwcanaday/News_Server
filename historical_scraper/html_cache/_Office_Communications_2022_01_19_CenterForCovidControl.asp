...
<meta name="description" content="Attorney General Ellison files lawsuit against COVID-19 testing sites, lab for deceiving consumers">
...
<meta name="twitter:title" content="Attorney General Ellison files lawsuit against COVID-19 testing sites, lab for deceiving consumers " />
<meta name="twitter:description" content="Attorney General alleges Center for COVID Control never sent test results, sent results far later than advertised, or sent false or inaccurate results to consumers" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2022/01/19_CenterForCovidControl.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison files lawsuit against COVID-19 testing sites, lab for deceiving consumers"/>
<meta property="og:description" content="Attorney General alleges Center for COVID Control never sent test results, sent results far later than advertised, or sent false or inaccurate results to consumers" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>January 19, 2022 Press Release</title>
...
<h1>Attorney General Ellison files lawsuit against COVID-19 testing sites, lab for deceiving consumers</h1>


<p class="lede">Attorney General alleges Center for COVID Control never sent test results, sent results far later than advertised, or sent false or inaccurate results to consumers</p>




	
<p><strong>January 19, 2022 (SAINT PAUL)</strong>Â â Minnesota Attorney General Keith Ellison today announced that he has filed a <a href="../docs/CenterForCovidControl_Complaint.pdf" target="_blank">lawsuit</a> in Hennepin County district court against two Illinois-based companies â Center for COVID Control, LLC and Doctors Clinical Laboratory, Inc. â that collected samples from Minnesotans for COVID-19 testing, but either failed to deliver test results, or delivered test results that were falsified or inaccurate.Â </p>

<p>The Attorney General received numerous complaints from Minnesotans who submitted COVID-19 tests at pop-up sites around the state operated by Center for Covid Control who reported never receiving their test results from the company&rsquo;s associated lab, Doctors Clinical Laboratory, despite waiting for weeks or more, or who received test results far later than the companies advertised. Some Minnesotans also reported receiving test results from the companies despite having never submitted a sample for testing. Still others reported receiving test results with false or inaccurate information about their test.Â Â </p>

<p>Former employees of Center for Covid Control reported that, while the company could initially handle its load of local tests, its processing center failed to expand as the company opened up testing sites around the country, including in Minnesota. The results, as one former employee described, were chaos, with received samples being stuffed into trash bags strewn across the office floor. Former employees recounted finding samples in bags that were well over 48 hours old, being instructed by management to falsify dates of receipt, and being instructed to lie to consumers about their tests being inconclusive or negative when, in fact, the sample had not been tested.Â </p>

<p>&ldquo;My job is to fight for Minnesotans&rsquo; security and help them live with dignity, safety, and respect. Making sure that Minnesotans have accurate tools to them safe from the COVID-19 pandemic is a key part of that job,&rdquo; Attorney General Ellison said. &ldquo;When Minnesotans and people from around the country tested with these companies to keep themselves and their families safe, they trusted they would get correct results on time. I&rsquo;m holding these companies accountable that sent back false or inaccurate results, when they sent them back at all, for deceiving Minnesotans and undermining the public&rsquo;s trust in testing. I want every Minnesotan to know that I will use every tool at my disposal to keep them safe and hold accountable companies that undermine their safety.&rdquo;Â </p>

<p>Attorney General Ellison urges Minnesota consumers to report their concerns with the Center for COVID Control and Doctors Clinical Laboratory, including inaccurate reporting or failure to receive test results by submitting a complaintÂ <a href="https://www.ag.state.mn.us/Office/Complaint.asp" target="_blank">here</a>Â or by calling the Attorney General&rsquo;s Office at (651) 296-3353 (Metro) or (800) 657-3787 (Greater Minnesota) or (800) 627-3529 (Minnesota Relay).Â </p>
