...
<meta name="description" content="Attorney General Ellison announces airline passenger protection partnership with U.S. Department of Transportation">
...
<meta name="twitter:title" content="Attorney General Ellison announces airline passenger protection partnership with U.S. Department of Transportation" />
<meta name="twitter:description" content="Ellison praised the new coordinated effort that will provide better protection to millions of U.S. airline passengers." />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />
	
<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2024/04/17_DOT.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Attorney General Ellison announces airline passenger protection partnership with U.S. Department of Transportation" />
<meta property="og:description" content="Ellison praised the new coordinated effort that will provide better protection to millions of U.S. airline passengers." />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	
	
	
<title>April 17, 2024 Press Release</title>
...
<h1>Attorney General Ellison announces airline passenger protection partnership with U.S. Department of Transportation</h1>



 <p style="margin-top:2em;"><strong>April 17, 2024 (SAINT PAUL)</strong>Â â Attorney General Ellison announced a newÂ <a href="https://www.ag.state.mn.us/Office/Communications/2024/docs/DOT_MOU.pdf">partnership</a>Â with the U.S. Department of Transportation to review and resolve consumer complaints against airlines and ticket agents. TheÂ <a href="https://www.ag.state.mn.us/Office/Communications/2024/docs/DOT_MOU.pdf">agreement</a>Â streamlines how the Attorney General and DOT will work together to review consumer complaints and identify violations of federal aviation consumer protection requirements.</p>
    <p>The new process for addressing consumer complaints against air travel companies, outlined in aÂ <a href="https://www.ag.state.mn.us/Office/Communications/2024/docs/DOT_MOU.pdf">memorandum of understanding between the Minnesota Attorney General&rsquo;s Office and the DOT</a>, reinforces state and federal commitments to protect the rights of travelers. Minnesota is one of 25 states or territories that either signed an MOU with the DOT or expressed an interest in executing such an agreement. This action comes at a time when complaints about flight disruptions, lack of refunds, and lost or delayed baggage continue to be core passenger concerns.</p>
    <p>Ellison praised the new coordinated effort that will provide better protection to millions of U.S. airline passengers.</p>
    <p>&ldquo;As Attorney General, it is my job to protect everyday Minnesotans from being ripped off by powerful corporations<strong>,&rdquo; said Attorney General Keith Ellison.</strong>Â &ldquo;I am thrilled that my office will now be able to help address consumer complaints against airlines and hold those airlines accountable when they do wrong by travelers. I look forward to making the most of this agreement to help Minnesotans afford their lives, and live with dignity, safety, and respect.&rdquo;</p>
    <p>&ldquo;We take our mission to protect consumers seriously, and today's launch of the Airline Passenger Protection Partnership is an important milestone in that effort,&rdquo;Â <strong>said U.S. Transportation Secretary Pete Buttigieg.</strong>Â &ldquo;By partnering with a bipartisan group of state attorneys general, the U.S. Department of Transportation has expanded our ability to hold airlines and ticket agents accountable and protect passengers from unfair or deceptive practices.&rdquo;</p>
    <p>Federal law places the central responsibility for protecting airline consumers with the DOT. Under this historic agreement, the attorney general&rsquo;s office will be authorized to investigate consumer complaints against air carriers, ticket agents, and other air travel companies supervised by the DOT. The attorney general&rsquo;s office will work with consumers and companies to resolve complaints, and if necessary, will refer complaints to the DOT&rsquo;s Office of Aviation Consumer Protection (OACP). The OACP will prioritize their review, include attorney general&rsquo;s office staff on letters of inquiry to those companies based on those referrals, and consult with the attorney general&rsquo;s office before determining next steps.</p>
    <p>The DOT will also provide technical assistance and training to staff in the attorney general&rsquo;s office and will meet at least once a year with the attorney general&rsquo;s office to assess ongoing efforts and to update Minnesota on any actions taken in response to state-referred complaints.</p>
    <p>The MOU will last for two years, and Minnesota and the DOT may agree to extend it at two-year intervals after the agreement ends.</p>
    <p>Ellison has urged the federal government to strengthen protections for airline passengers andÂ <a href="https://coag.gov/app/uploads/2022/08/NAAG-Policy-Letter-Airline-Accountability-and-Increased-Consumer-Protection.pdf">asked Congress to authorize state attorneys general</a>Â enforcement of federal consumer protection laws governing the airline industry.</p>
    <p>Others that have signed an MOU with the DOT include the attorneys general from California, Colorado, Connecticut, the District of Columbia, Illinois, Maine, Maryland, Michigan, Nevada, New York, New Hampshire, North Carolina, the Northern Mariana Islands, Oklahoma, Pennsylvania, Rhode Island, the U.S. Virgin Islands, and Wisconsin.</p>
   
    <p>Those that have expressed an interest in executing such an agreement with DOT include the attorneys general from Delaware, Massachusetts, Oregon, Tennessee, Vermont, and Washington.</p>
