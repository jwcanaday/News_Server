...
<meta name="description" content="AG Ellison applauds end of lawsuit challenging Trump administrationâs food-assistance cuts; urges Congress to expand the program">
...
<meta name="twitter:title" content="AG Ellison applauds end of lawsuit challenging Trump administrationâs food-assistance cuts; urges Congress to expand the program" />
<meta name="twitter:description" content="Biden Administration agrees to dismiss appeal of decision that Trump SNAP rule was arbitrary, poorly reasoned, and contrary to Congressâs intent" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2021/03/24_FoodAssistance.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content="AG Ellison applauds end of lawsuit challenging Trump administrationâs food-assistance cuts; urges Congress to expand the program" />
<meta property="og:description" content="Biden Administration agrees to dismiss appeal of decision that Trump SNAP rule was arbitrary, poorly reasoned, and contrary to Congressâs intent" />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>March 24, 2021 Press Release</title>
...
<h1>AG Ellison applauds end of lawsuit challenging Trump administrationâs food-assistance cuts; urges Congress to expand the program</h1>


<p class="lede">Biden Administration agrees to dismiss appeal of decision that Trump SNAP rule was arbitrary, poorly reasoned, and contrary to Congressâs intent</p>


	<p><strong>March 24, 2021 (SAINT PAUL)</strong> âÂ Attorney General Keith Ellison today applauded theÂ <a href="https://oag.dc.gov/sites/default/files/2021-03/SNAP-Order.pdf" target="_blank">dismissal</a>Â of an appeal of a decision that struck down the Trump Administration&rsquo;s attempt to revoke eligibility for food assistance for approximately 700,000 Americans, including 8,000 Minnesotans.Â </p>
	
	<p><a href="https://www.ag.state.mn.us/Office/Communications/2020/01/16_SNAP.asp" target="_blank">In January 2020, Attorney General Ellison joined a multistate lawsuit</a>Â against the United States Department of Agriculture (USDA) to challenge a new rule that would have severely limited states&rsquo; flexibility to provide food assistance to individuals struggling to find work. Siding with the coalition, Chief Judge Beryl Howell of the U.S. District Court for the District of Columbia temporarily halted parts of the rule in March 2020 andÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/10/20_SNAP.asp" target="_blank">struck down the rule in its entirety in October 2020</a>, protectingÂ access to SNAP benefits for Minnesota residents who rely on the program. Â </p>
	
	<p>The Trump Administration initially appealed that decision, but on Monday, the Biden Administration Department of Agriculture asked the U.S. Court of Appeals for the D.C. Circuit to dismiss the appeal, which the Court did today. As a result, Chief Judge Howell&rsquo;s decision striking down the rule is final, and the cuts will not go into effect.Â Â Â </p>
	
	<p>Â &ldquo;It&rsquo;s hard to believe that anyone would want to make it even harder than it already is for people to afford their lives and even harder for some people to afford to eat, but that&rsquo;s exactly what the Trump administration was doing,&rdquo; said Attorney General Ellison. &ldquo;I&rsquo;m glad to have joined this lawsuit to protect the people of Minnesota and am glad these terrible cuts are now off the table.&rdquo;Â </p>
	
	<h2>Ellison urges Congress pass Improving Access to Nutrition Act</h2>
	
	<p>Based on the expertise developed defending SNAP from the Trump Administration&rsquo;s attempted cuts, last Friday, March 19,Â <a href="https://oag.dc.gov/sites/default/files/2021-03/Improving-Access-to-Nutrition-Act_Letter-to-Congress.pdf" target="_blank">Attorney General EllisonÂ joined a letter to Congress</a>, signed by 17 states, the District of Columbia, and the City of New York, in support of the Improving Access to Nutrition Act. If enacted, the bill would lift limitations on the time period during which able-bodied adults without dependents can access benefits. Â </p>
	
	<p>In the latter, Attorney General Ellison and the other signers argue that those limitations have proven ineffective in encouraging employment and serve only to prevent those who cannot find work from accessing essential nutrition. The coalition further notes that the process for seeking waivers and exemptions from the time period due to lack of jobs in an area creates significant administrative burdens on states, and that the data needed to show a lack of jobs is not always available. Finally, the letter notes that passage of the Improving Access to Nutrition Act would prevent future administrations from cruel attempts to cut off nutritional assistance. Â </p>
	<p align="left">&nbsp;</p>
