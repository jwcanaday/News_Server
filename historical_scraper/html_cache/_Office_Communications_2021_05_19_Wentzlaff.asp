...
<meta name="description" content="Attorney General Ellison wins relief for tenants whose landlord falsely claimed she needed to move in in order to kick the tenants out
">
...
<meta name="twitter:title" content=" Attorney General Ellison wins relief for tenants whose landlord falsely claimed she needed to move in in order to kick the tenants out
" />
<meta name="twitter:description" content="Landlord to pay former tenants $3.5K, comply with executive orders protecting tenant rights in resolution of enforcement action for violating Executive Order 20-79" />
<meta name="twitter:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />

<meta property="og:url" content="https://www.ag.state.mn.us/Office/Communications/2021/05/19_Wentzlaff.asp" />
<meta property="og:type" content="article" />
<meta property="og:title" content=" Attorney General Ellison wins relief for tenants whose landlord falsely claimed she needed to move in in order to kick the tenants out
"/>
<meta property="og:description" content="Landlord to pay former tenants $3.5K, comply with executive orders protecting tenant rights in resolution of enforcement action for violating Executive Order 20-79 " />
<meta property="og:image" content="https://www.ag.state.mn.us/_Img/Logo_SM.jpg" />	

<title>May 19, 2021 Press Release</title>
...
<h1> Attorney General Ellison wins relief for tenants whose landlord falsely claimed she needed to move in in order to kick the tenants out
 </h1>


<p class="lede">Landlord to pay former tenants $3.5K, comply with executive orders protecting tenant rights in resolution of enforcement action for violating Executive Order 20-79</p>
<p class="lede">AGâs office has received nearly 3K complaints of EO violations; seven of eight total enforcement actions AGâs office has filed now resolved</p>


	<p align="left"><strong>May 19, 2021 (SAINT PAUL)Â </strong>âÂ Minnesota Attorney General Keith Ellison announced today that his office has resolved anÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/docs/Wentzlaff_Complaint.pdf" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="0">enforcement action</a>Â against a landlord who forced her tenants out of their home in violation ofÂ <a href="https://www.leg.mn.gov/archive/execorders/20-79.pdf" target="_blank">Executive Order 20-79</a>, which protects tenants from eviction during the COVID-19 peacetime emergency.Â </p>
	
	<p align="left">Attorney General Ellison&rsquo;s officeÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/02/17_Wentzlaff.asp" target="_blank">sued Dakota County landlord Joanna Wentzlaff</a>Â in February, alleging that Wentzlaff used an exemption in Executive Order 20-79, which permits landlords to terminate a lease if they need to move into the property themselves, as a pretext to force her tenants out so that she could sell her home. Wentzlaff falsely claimed she or a family member needed to move into the rental property, when in reality she had already hired a real estate agent to help her sell it. The property in Apple Valley has since been sold.Â Â Â </p>
	
	<p align="left">TheÂ <a href="https://www.ag.state.mn.us/Office/Communications/2021/docs/Wentzlaff_ConsentJudgment.pdf" target="_blank">consent judgment</a>Â entered by the court requires Wentzlaff to pay $3,573.86 in part to reimburse the tenants for their out-of-pocket costs in being forced out, and also requires Wentzlaff to remain in compliance with the Governor&rsquo;s executive orders protecting tenant rights.Â </p>
	
	<p align="left">&ldquo;Having a safe and affordable roof over your head is essential to living with dignity and respect. During the COVID-19 pandemic, it&rsquo;s also been essential to protecting people&rsquo;s lives,&rdquo; Attorney General Ellison said. &ldquo;The vast majority of landlords have done the right thing by their tenants and their communities during the pandemic: for those that have not, this case shows once again that my office will hold landlords accountable who violate the executive orders and put the health of their communities and the lives of their tenants at risk.&rdquo;Â </p>
	
	<p align="left">UnderÂ <a href="https://www.leg.mn.gov/archive/execorders/20-79.pdf" target="_blank">Governor Walz&rsquo;s Emergency Executive Order 20-79</a>, property owners are prohibited from filing eviction actions, terminating residential leases, or issuing notices of non-renewal for the duration of the COVID-19 peacetime emergency.Â Â An exemption to the Executive Order permits property owners, however, to terminate or not renew a lease &ldquo;due to the need to move the property owner or property owner&rsquo;s family member(s) into the property&rdquo; as long as the &ldquo;property owner or property owner&rsquo;s family member(s) move into the property within 7 days after it is vacated by the tenant.&rdquo;Â Â Â </p>
	
	<p align="left">Attorney General Ellison&rsquo;s office, which has the authority to enforce Executive Order 20-79, has fielded nearly 3,000 consumer complaints since the peacetime emergency was declared.Â The office has filed eight enforcement actions against landlords for violating those orders and has now resolved seven. AÂ <a href="https://www.ag.state.mn.us/Office/Communications/2020/04/03_Mostad.asp" target="_blank">lawsuit against a Pine County landlord</a>Â who forced his way into his tenants&rsquo; home and disconnected their electricity in an effort to force them out of the home is currently in litigation.Â </p>
	
	<p align="left">Attorney General Ellison encourages Minnesotans to report any suspected violations of Executive Order 20-79, which suspends evictions and lease terminations during the COVID-19 peacetime emergency, by filling out the dedicatedÂ <a href="https://www.ag.state.mn.us/Office/Forms/TenantEvictionComplaint.asp" target="_blank" >Tenant Eviction Complaint Form</a>Â on theÂ front page of the Attorney General&rsquo;s website. Attorney General Ellison&rsquo;s website also features dedicated links forÂ <a href="https://www.ag.state.mn.us/Office/Forms/PriceGougingComplaint.asp" target="_blank">price-gouging complaints</a>Â and forÂ <a href="https://www.ag.state.mn.us/Office/Forms/COVID19Complaint.asp" target="_blank">other COVID-19-related complaints</a>.Â Â Minnesotans can also report violations by calling Attorney General Ellison&rsquo;s office at (651) 296-3353 (Metro) or (800) 657-3787 (Greater Minnesota).Â </p>
